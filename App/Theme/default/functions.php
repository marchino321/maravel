 ...
 * ===============================
 */
ThemeManager::addCss('/App/public/css/bootstrap-dark.min.css', 'bs-dark-css');
ThemeManager::addCss('/App/public/css/app-dark.min.css', 'app-default-stylesheet', ['bs-dark-css']);
ThemeManager::addCss('https://cdn.jsdelivr.net/npm/@sweetalert2/theme-dark@5/dark.css', 'sweetalert2-dark-css');
 ...
 * ===============================
 */
ThemeManager::addOnce('footer.before', function () {
