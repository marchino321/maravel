...
!(function () {
    ...
    var Re,
        ...
        Je = [
            ...
            { name: "Firefox", versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: Ge("firefox") },
            {
                name: "Safari",
        ...
        Qe = [
            { name: "Windows", search: Ge("win"), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/] },
            {
                name: "iOS",
                search: function (e) {
            ...
            { name: "OSX", search: Ge("mac os x"), versionRegexes: [/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/] },
            { name: "Linux", search: Ge("linux"), versionRegexes: [] },
            { name: "Solaris", search: Ge("sunos"), versionRegexes: [] },
            { name: "FreeBSD", search: Ge("freebsd"), versionRegexes: [] },
            { name: "ChromeOS", search: Ge("cros"), versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/] },
        ],
        Ze = { browsers: S(Je), oses: S(Qe) },
        et = "Firefox",
        tt = function (e) {
            var t = e.current,
                n = e.version,
            ...
            return { current: t, version: n, isEdge: r("Edge"), isChrome: r("Chrome"), isIE: r("IE"), isOpera: r("Opera"), isFirefox: r(et), isSafari: r("Safari") };
        },
        nt = {
            unknown: function () {
        ...
        st = function (e) {
            ...
            return { current: t, version: n, isWindows: r(rt), isiOS: r("iOS"), isAndroid: r(ot), isOSX: r("OSX"), isLinux: r("Linux"), isSolaris: r(it), isFreeBSD: r(at), isChromeOS: r(ut) };
        },
        ct = {
            unknown: function () {
        ...
        lt = function (e, t) {
            var n,
                ...
                p = Ze.browsers(),
                g = Ze.oses(),
                h = je(p, e).fold(nt.unknown, nt.nu),
            ...
            return {
                ...
                deviceType:
                    ...
                    (m = !f && !l && !d),
                    { isiPad: S(a), isiPhone: S(u), isTablet: S(l), isPhone: S(f), isTouch: S(c), isAndroid: n.isAndroid, isiOS: n.isiOS, isWebView: S(d), isDesktop: S(m) }),
            };
        },
        ft = function (e) {
        ...
        xt = {
            ...
            windowsPhone: wt,
            browser: { current: ht.current, version: ht.version, isChrome: ht.isChrome, isEdge: ht.isEdge, isFirefox: ht.isFirefox, isIE: ht.isIE, isOpera: ht.isOpera, isSafari: ht.isSafari },
            os: {
                current: vt.current,
                version: vt.version,
            ...
            deviceType: { isDesktop: yt.isDesktop, isiPad: yt.isiPad, isiPhone: yt.isiPhone, isPhone: yt.isPhone, isTablet: yt.isTablet, isTouch: yt.isTouch, isWebView: yt.isWebView },
        },
        St = /^\s*|\s*$/g,
        Nt = function (e) {
        ...
        nn = D(Element.prototype.attachShadow) && D(Node.prototype.getRootNode),
        rn = S(nn),
        on = nn
            ? function (e) {
        ...
        qn = Ln("false"),
        $n = Tn(["td", "th"]),
        Wn = Tn(["video", "audio", "object", "embed"]),
        Kn = function (e) {
        ...
        sr = function (e, t, n) {
            var r,
                ...
                s = e.ownerDocument;
            if (((n = n || e), t)) {
                if (n === e && t.getBoundingClientRect && "static" === tr(Rt.fromDom(e), "position"))
                    return {
    ...
    (Oe = undefined),
        ...
        (Le = undefined),
        (function (e) {
            "object" == typeof Be && void 0 !== Pe
                ? (Pe.exports = e())
                : "function" == typeof Oe && Oe.amd
                ? Oe([], e)
        ...
        Ir = window.Promise
            ...
            : ((Nr = function (n, r) {
              ...
              (kr.resolve = function (t) {
                  return t && "object" == typeof t && t.constructor === kr
                      ? t
                      : new kr(function (e) {
                            e(t);
                        });
                    ...
                    t && i.passed.push(t),
                        ...
                        1 !== i.status &&
                            (2 !== i.status
                                ? 3 !== i.status
                                    ? ((i.status = 1),
                                      (a = Rt.fromTag("link", y.dom)),
                                      Gn(a, { rel: "stylesheet", type: "text/css", id: i.id }),
                                      (u = Date.now()),
                                      p.contentCssCors && Yn(a, "crossOrigin", "anonymous"),
                                      p.referrerPolicy && Yn(a, "referrerpolicy", p.referrerPolicy),
                                      ((r = a.dom).onload = d),
                                      (r.onerror = f),
                                      (s = a),
                                      dn(an(v), s),
    ...
    var Jr,
        ...
        io = Zr(["ul", "ol", "dl"]),
        ao = Zr(["li", "dd", "dt"]),
        uo = Zr(["thead", "tbody", "tfoot"]),
        so = Zr(["td", "th"]),
        co = Zr(["pre", "script", "textarea", "style"]),
        lo = "\ufeff",
        fo = "\xa0",
        mo = lo,
        po = function (e) {
        ...
        _o = function (e) {
            return e && e.hasAttribute("data-mce-caret")
                ? ((t = e.getElementsByTagName("br")),
                  (n = t[t.length - 1]),
                  Bn(n) && n.parentNode.removeChild(n),
        ...
        To = jn,
        Do = Mn,
        Oo = Tn(["script", "style", "textarea"]),
        Bo = Tn(["img", "input", "textarea", "hr", "iframe", "video", "audio", "object", "embed"]),
        Po = Tn(["table"]),
        Lo = Co,
        Io = function (e) {
        ...
        Vo = On("data-mce-bookmark"),
        qo = On("data-mce-bogus"),
        $o =
            ((Jr = "data-mce-bogus"),
            (Qr = "all"),
            function (e) {
                ...
                return e.replace(ti, function (e, t) {
                    return t
                        ? 65535 < (t = "x" === t.charAt(0).toLowerCase() ? parseInt(t.substr(1), 16) : parseInt(t, 10))
                            ...
                            : ni[t] || String.fromCharCode(t)
                        : oi[e] || ai[e] || ((n = e), ((r = Rt.fromTag("div").dom).innerHTML = n), r.textContent || r.innerText || n);
                    var n, r;
                });
            },
        },
        ...
        Ci = function (i) {
            var e,
                ...
                g =
                    ...
                    (u = function (e, t, n) {
                        ...
                        for (var a = yi(e), u = a.length; u--; ) (o = { attributes: i((r = yi([s, t].join(" ")))), attributesOrder: r, children: i(n, di) }), (c[a[u]] = o);
                    }),
                    (l = function (e, t) {
                        ...
                        : ((s = "id accesskey class dir lang style tabindex title role"),
                          ...
                          "html5-strict" !== e &&
                              ((s += " xml:lang"),
                              (n = [n, (a = "acronym applet basefont big font strike tt")].join(" ")),
                              pi(yi(a), function (e) {
                                  u(e, "", n);
                              }),
                          ...
                          u("body", "onafterprint onbeforeprint onbeforeunload onblur onerror onfocus onhashchange onload onmessage onoffline ononline onpagehide onpageshow onpopstate onresize onscroll onstorage onunload", r),
                          u("address dt dd div caption", "", r),
                          u("h1 h2 h3 h4 h5 h6 pre p abbr code var samp kbd sub sup i b u bdo span legend em strong small s cite dfn", "", n),
                          u("blockquote", "cite", r),
                          u("ol", "reversed start type", "li"),
                          u("ul", "", "li"),
                          u("li", "value", r),
                          u("dl", "", "dt dd"),
                          u("a", "href target rel media hreflang type", n),
                          u("q", "cite", n),
                          u("ins del", "cite datetime", r),
                          u("img", "src sizes srcset alt usemap ismap width height"),
                          u("iframe", "src name width height", r),
                          u("embed", "src type width height"),
                          u("object", "data type typemustmatch name usemap form width height", [r, "param"].join(" ")),
                          u("param", "name value"),
                          u("map", "name", [r, "area"].join(" ")),
                          ...
                          u("tr", "", "td th"),
                          u("td", "colspan rowspan headers", r),
                          u("th", "colspan rowspan headers scope abbr", r),
                          u("form", "accept-charset action autocomplete enctype method name novalidate target", r),
                          u("fieldset", "disabled form name", [r, "legend"].join(" ")),
                          u("label", "form for", n),
                          u(
                              "input",
                          ...
                          u("button", "disabled form formaction formenctype formmethod formnovalidate formtarget name type value", "html4" === e ? r : n),
                          ...
                          u("menu", "type label", [r, "li"].join(" ")),
                          u("noscript", "", r),
                          "html4" !== e &&
                              (u("wbr"),
                              u("ruby", "", [n, "rt rp"].join(" ")),
                              u("figcaption", "", r),
                              u("mark rt rp summary bdi", "", n),
                              u("canvas", "width height", r),
                              u("video", "src crossorigin poster preload autoplay mediagroup loop muted controls width height buffered", [r, "track source"].join(" ")),
                              u("audio", "src crossorigin preload autoplay mediagroup loop muted controls buffered volume", [r, "track source"].join(" ")),
                              u("picture", "", "img source"),
                              u("source", "src srcset type media sizes"),
                              u("track", "kind src srclang label default"),
                              u("datalist", "", [n, "option"].join(" ")),
                              u("article section nav aside main header footer", "", r),
                              u("hgroup", "", "h1 h2 h3 h4 h5 h6"),
                              u("figure", "", [r, "figcaption"].join(" ")),
                              u("time", "datetime", n),
                              u("dialog", "open", r),
                              u("command", "type label icon disabled checked radiogroup command"),
                              u("output", "for form name", n),
                              u("progress", "value max", n),
                              u("meter", "value min max low high optimum", n),
                              u("details", "open", [r, "summary"].join(" ")),
                          ...
                          pi(yi("a form meter progress dfn"), function (e) {
            ...
            var h = bi(i.valid_styles),
                v = bi(i.invalid_styles, "map"),
                y = bi(i.valid_classes, "map"),
                ...
                k = p("non_empty_elements", E + " pre", w),
            ...
            var D = function (e) {
                                    ...
                                    for (r = 0, o = (s = yi(s, "|")).length; r < o; r++)
                                        if ((i = C.exec(s[r]))) {
                                            ...
                                            p &&
                                                ...
                                                "<" === p && (u.validValues = mi(y, "?"))),
                                                w.test(l) ? ((a.attributePatterns = a.attributePatterns || []), (u.pattern = D(l)), a.attributePatterns.push(u)) : (d[l] || m.push(l), (d[l] = u));
                                        }
                ...
                P = function (e) {
                    var a = /^(~)?(.+)$/;
                    e &&
                        ((fi.text_block_elements = fi.block_elements = null),
                        pi(yi(e, ","), function (e) {
                            var t,
                                n = a.exec(e),
                                r = "~" === n[1],
                            ...
                            (f[i] = f[o]),
                                ...
                                S[i] || ((t = S[o]), delete (t = gi({}, t)).removeEmptyAttrs, delete t.removeEmpty, (S[i] = t)),
                                pi(f, function (e, t) {
                    ...
                    (fi[i.schema] = null),
                        e &&
                            pi(yi(e, ","), function (e) {
                                ...
                                r &&
                                    ((n = r[1]),
                                    (t = n ? f[r[2]] : (f[r[2]] = { "#comment": {} })),
                                    (t = f[r[2]]),
                                    pi(yi(r[3], "|"), function (e) {
                                        "-" === n ? delete t[e] : (t[e] = {});
                                    }));
                            });
                },
            ...
            i.valid_elements
                ...
                : (pi(g, function (e, t) {
                  ...
                  "html5" !== i.schema &&
                      pi(yi("strong/b em/i"), function (e) {
                          var t = yi(e, "/");
                ...
                L("+ol[ul|ol],+ul[ul|ol]"),
                pi({ dd: "dl", dt: "dl", li: "ul ol", td: "tr", th: "tr", tr: "tbody thead tfoot", tbody: "table", thead: "table", tfoot: "table", legend: "fieldset", area: "map", param: "video audio object" }, function (e, t) {
                    S[t] && (S[t].parentsRequired = yi(e));
                }),
                i.invalid_elements &&
                    pi(hi(i.invalid_elements), function (e) {
                        S[e] && delete S[e];
                    }),
        ...
        Ni = { keyLocation: 1, layerX: 1, layerY: 1, returnValue: 1, webkitMovementX: 1, webkitMovementY: 1, keyIdentifier: 1, mozPressure: 1 },
        Ei = b,
        ki = w,
        _i = function (e, t, n, r) {
        ...
        Ri = function (e, t) {
            ...
            return (
                ...
                !(s.stopImmediatePropagation = function () {
                    ...
                    ((s.isDefaultPrevented = !0 === s.defaultPrevented ? ki : Ei), (s.isPropagationStopped = !0 === s.cancelBubble ? ki : Ei), (s.isImmediatePropagationStopped = Ei)),
                                            ...
                                            ? (function (e, t, n) {
                                                  ...
                                                  n.domLoaded
                                                      ...
                                                      : ((r = function () {
                                                        ...
                                                        "complete" === o.readyState || ("interactive" === o.readyState && o.body) ? r() : _i(e, "DOMContentLoaded", r),
    ...
    (Oi = Ta.support = {}),
                ...
                ? ((qi = (Vi = s).documentElement),
                  ...
                  (na = t
                      ? function (e, t) {
                            ...
                            return (
                                n ||
                                (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || (!Oi.sortDetached && t.compareDocumentPosition(e) === n)
        ...
        (Ta.matchesSelector = function (e, t) {
            if (((e.ownerDocument || e) !== Vi && Hi(e), (t = t.replace(ya, "='$1']")), Oi.matchesSelector && $i && (!Ki || !Ki.test(t)) && (!Wi || !Wi.test(t))))
                try {
        ...
        ((Bi = Ta.selectors = {
            ...
            preFilter: {
                ...
                CHILD: function (e) {
                    return (
                        (e[1] = e[1].toLowerCase()),
                        "nth" === e[1].slice(0, 3) ? (e[3] || Ta.error(e[0]), (e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * ("even" === e[3] || "odd" === e[3]))), (e[5] = +(e[7] + e[8] || "odd" === e[3]))) : e[3] && Ta.error(e[0]),
                        e
                    );
                },
                PSEUDO: function (e) {
                    ...
                    return wa.CHILD.test(e[0])
                        ? null
                        : (e[3] ? (e[2] = e[4] || e[5] || "") : n && ba.test(n) && (t = Ii(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
                },
            },
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === p && 0 === g
                        ...
                        : function (e, t, n) {
                              ...
                              if (l) {
                                  ...
                                  } else if (d && (r = (e[Yi] || (e[Yi] = {}))[m]) && r[0] === Ji) a = r[1];
                                  else for (; (i = (++u && i && i[c]) || (a = u = 0) || s.pop()) && ((y ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[Yi] || (i[Yi] = {}))[m] = [Ji, a]), i !== e)); );
        ...
        (Ii = Ta.tokenize = function (e, t) {
            ...
            for (a = e, u = [], s = Bi.preFilter; a; ) {
                for (i in ((n && !(r = ha.exec(a))) || (r && (a = a.slice(r[0].length) || a), u.push((o = []))),
                (n = !1),
                (r = va.exec(a)) && ((n = r.shift()), o.push({ value: n, type: r[0].replace(ga, " ") }), (a = a.slice(n.length))),
                Bi.filter))
                    Bi.filter.hasOwnProperty(i) && (!(r = wa[i].exec(a)) || (s[i] && !(r = s[i](r))) || ((n = r.shift()), o.push({ value: n, type: i, matches: r }), (a = a.slice(n.length))));
                if (!n) break;
            }
    ...
    var Ha = document,
        ...
        $a = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,
        Wa = Ti.Event,
        Ka = _t.makeMap("children,contents,next,prev"),
        Xa = function (e) {
            return void 0 !== e;
        },
        Ya = function (e) {
        ...
        Ja = function (e, t, n, r) {
            ...
            if (Ya(t)) t = Ga(t, fu(e[0]));
                ...
                if (((t = gu.makeArray(t)), r)) for (o = t.length - 1; 0 <= o; o--) Ja(e, t[o], n, r);
    ...
    (au.fn = au.prototype = {
        ...
        init: function (e, t) {
            ...
            if (Ya(e)) {
                ...
                if (n[1]) for (r = Ga(e, fu(t)).firstChild; r; ) Va.call(o, r), (r = r.nextSibling);
                else {
        ...
        add: function (e, t) {
            ...
            if (!1 !== t) for (n = gu.unique(this.toArray().concat(gu.makeArray(e))), this.length = n.length, r = 0; r < n.length; r++) this[r] = n[r];
            else Va.apply(this, gu.makeArray(e));
            return this;
        },
        attr: function (t, n) {
            var e,
    ...
    var du = function (e, t, n) {
        ...
        mu = function (e, t, n, r) {
            var o = [];
            for (r instanceof gu && (r = r[0]); e; e = e[t])
                if (!n || e.nodeType === n) {
                    if (r !== undefined) {
                        if (e === r) break;
    ...
    var gu = au,
        ...
        xu = function (a, u) {
            ...
            var n,
                ...
                m = [],
                p = u.schema ? u.schema : Ci({}),
                g = xi({ url_converter: u.url_converter, url_converter_scope: u.url_converter_scope }, u.schema),
                h = u.ownEvents ? new Ti() : Ti.Event,
                v = p.getBlockElements(),
                y = gu.overrideDefaults(function () {
                ...
                R = function (e, t, n, r) {
                    ...
                    for (
                        r = r === undefined,
                            n = n || ("BODY" !== N().nodeName ? N().parentNode : null),
                            _t.is(t, "string") &&
                                (t =
                                    "*" === (o = t)
                                        ? function (e) {
                ...
                D = function (e, n, r) {
                    ...
                    if (!t) return !1;
                    if (_t.isArray(t) && (t.length || 0 === t.length))
                        return (
                            (o = []),
                            hu(t, function (e, t) {
                ...
                U = function (t, e, n) {
                    return D(e, function (e) {
                        return (
                            _t.is(e, "array") && (t = t.cloneNode(!0)),
                            n &&
                                hu(vu(e.childNodes), function (e) {
                                    t.appendChild(e);
                                }),
                ...
                $ = {
                    ...
                    isEmpty: function (e, t) {
                        ...
                        if (z(e)) return !1;
                        if ((e = e.firstChild)) {
                            var i = new Yr(e, e.parentNode),
                                a = p ? p.getWhiteSpaceElements() : {};
                    ...
                    split: function (e, t, n) {
                        ...
                        if (e && t)
                            return (
                                a.setStart(e.parentNode, wu(e)),
                                a.setEnd(t.parentNode, wu(t)),
                                (r = a.extractContents()),
                                (a = j()).setStart(t.parentNode, wu(t) + 1),
                                a.setEnd(e.parentNode, wu(e) + 1),
                                (o = a.extractContents()),
                                (i = e.parentNode).insertBefore(Go($, r), e),
                                n ? i.insertBefore(n, e) : i.insertBefore(t, e),
                                i.insertBefore(Go($, o), e),
                                M(e),
                                n || t
                            );
                    },
    ...
    var Su = xu.DOM,
        ...
        Eu = _t.grep,
        ku =
            ((_u.prototype._setReferrerPolicy = function (e) {
            ...
            (_u.prototype.loadScript = function (e, t, n) {
                ...
                (a.id = i),
                    ...
                    (a.src = _t._addCacheSuffix(e)),
                    this.settings.referrerPolicy && r.setAttrib(a, "referrerpolicy", this.settings.referrerPolicy),
                    (a.onload = function () {
                        o(), t();
                    }),
                    (a.onerror = function () {
            ...
            (_u.prototype.add = function (e, t, n, r) {
                var o = this.states[e];
                this.queue.push(e), o === undefined && (this.states[e] = 0), t && (this.scriptLoadedCallbacks[e] || (this.scriptLoadedCallbacks[e] = []), this.scriptLoadedCallbacks[e].push({ success: t, failure: r, scope: n || this }));
            }),
        ...
        Bu = function () {
            var o = [],
                ...
                d = function (o, i, a, u, e) {
                    var t, n;
                    r[o] ||
                        (0 !== (t = "string" == typeof i ? i : i.prefix + i.resource + i.suffix).indexOf("/") && -1 === t.indexOf("://") && (t = Bu.baseURL + "/" + t),
                        (r[o] = t.substring(0, t.lastIndexOf("/"))),
                        (n = function () {
                            var n, e, t, r;
                            c(o, "loaded"),
                                (n = i),
                ...
                e = function (e, t, n) {
                    void 0 === n && (n = "added"), (ve(s, e) && "added" === n) || (ve(r, e) && "loaded" === n) ? t() : i.push({ name: e, state: n, callback: t });
                };
            return {
                items: o,
                urls: r,
    ...
    var Pu = function (n, r) {
        ...
        $u = S("mce-annotation"),
        Wu = S("data-mce-annotation"),
        Ku = S("data-mce-annotation-uid"),
        Xu = function (r, e) {
            var t = r.selection.getRng(),
                n = Rt.fromDom(t.startContainer),
                o = Rt.fromDom(r.getBody()),
                i = e.fold(
                    function () {
                        return "." + $u();
                    },
        ...
        Gu = function (i, e) {
            var a = Au({}),
                ...
                u = function (e, t) {
                    var n = a.get(),
                        r = t(n.hasOwnProperty(e) ? n[e] : { listeners: [], previous: Au(U.none()) });
                    (n[e] = r), a.set(n);
                },
                t = Lu(function () {
                    var e,
        ...
        es = function (e, t) {
            var n,
                r,
                o = Vt(e).dom,
                i = Rt.fromDom(o.createDocumentFragment()),
        ...
        ys = Rn,
        bs = Io,
        Cs = Dn("display", "block table"),
        ws = Dn("float", "left right"),
        xs = (function () {
            for (var n = [], e = 0; e < arguments.length; e++) n[e] = arguments[e];
            return function (e) {
        ...
        Ss = d(Dn("white-space", "pre pre-line pre-wrap")),
        Ns = Mn,
        Es = jn,
        ks = xu.nodeIndex,
        _s = gs,
        ...
        Bs = function (e) {
            ...
            return !Ts(e) && Es(e) && Os(n)
                ? (function (e) {
                      var t = e.ownerDocument,
                          n = As(t),
                          r = t.createTextNode(fo),
                          o = e.parentNode;
    ...
    var Ms,
        ...
        Xs = function (e, t) {
            ...
            return (
                ...
                (o = xe(o, d(Bn))),
                (i = i.concat(we(o, Ks))).reverse().join("/") + "," + n
            );
        },
        Ys = function (e, t) {
            if (!t) return null;
            ...
            return i
                ? js(i)
                    ...
                    : ((o = "after" === o ? Vs(i) + 1 : Vs(i)), Is(i.parentNode, o))
                : null;
        },
        Gs = qn,
        ...
        nc = function (e, t, n) {
            ...
            var a,
                ...
                f,
                d,
                m = tc((a = i).startContainer, a.startOffset) || tc(a.endContainer, a.endOffset);
            return m ? { name: (o = m.tagName), index: Qs(n.dom, o, m) } : ((u = e), (c = t), (l = i), (f = (s = n).dom), ((d = {}).start = Js(f, u, c, l, !0)), s.isCollapsed() || (d.end = Js(f, u, c, l, !1)), d);
        },
        rc = function (e, t, n) {
        ...
        ic = function (e, t, n) {
            return 2 === t ? nc(go, n, e) : 3 === t ? ((o = (r = e).getRng()), { start: Xs(r.dom.getRoot(), Is.fromRangeStart(o)), end: Xs(r.dom.getRoot(), Is.fromRangeEnd(o)) }) : t ? { rng: e.getRng() } : oc(e, !1);
            var r, o;
        },
        ac = N(nc, o, !0),
        uc = xu.DOM,
                ...
                show: function (t, e) {
                    ...
                    if (!a(e))
                        return (
                            (u = (function (e, t) {
                                var n,
                                    r = e.ownerDocument.createTextNode(mo),
                                    o = e.parentNode;
                                if (t) {
        ...
        Hc = qn,
        Vc = Wn,
        qc = Dn("display", "block table table-cell table-caption list-item"),
        $c = Co,
        Wc = yo,
        Kc = Rn,
        Xc = Io,
    ...
    var ll,
        ...
        Sl = function (e, t, n) {
            ...
            if (gl(l)) {
                ...
                if (0 < e && f < l.childNodes.length && ((o = wl(l, f)), yl(o)))
                    return vl(o)
                        ? ((u = n), (c = (s = o).nextSibling) && yl(c) ? (gl(c) ? Is(c, 0) : Is.before(c)) : Sl(Ms.Forwards, Is.after(s), u))
                        : !bl(o) && (i = Gc(o, e, Cl, o))
                        ? gl(i)
                            ? Is(i, 0)
                            : Is.before(i)
            ...
            if (c) {
                if (
                    ...
                    for (
                        a = c.previousSibling,
                            i = c.nextSibling,
                            _t.each(_t.grep(c.childNodes), function (e) {
        ...
        Zl = function (e, t, n) {
            ...
            if ((n.startContainer !== n.endContainer || !(a = n.startContainer.childNodes[n.startOffset]) || !/^(IMG)$/.test(a.nodeName)) && 1 === s.nodeType)
                for (u < (i = s.childNodes).length ? ((s = i[u]), (r = new Yr(s, e.getParent(s, e.isBlock)))) : ((s = i[i.length - 1]), (r = new Yr(s, e.getParent(s, e.isBlock))).next(!0)), o = r.current(); o; o = r.next())
                    if (3 === o.nodeType && !rf(o)) return n.setStart(o, 0), void t.setRng(n);
        },
        ef = function (e, t, n) {
            if (e) {
        ...
        Nf = function (e, t, n, r, o) {
            ...
            for (var i = hf(e, r), a = 0; a < i.length; a++)
        ...
        Ef = function (t, e, n, r) {
            ...
            if (
                ...
                i && e[0].wrapper && (i = hf(a, i, "ul,ol").reverse()[0] || i),
                !i)
            )
                for (i = n; i[r] && !a.isBlock(i[r]) && ((i = i[r]), !af(i, "br")); );
            return i || n;
        },
        kf = function (e, t, n, r) {
            var o = n.parentNode;
        ...
        Rf = function (e, t, n, r) {
            ...
            var o = t.startContainer,
                ...
                s = e.dom;
            return (
                Rn(o) && o.hasChildNodes() && ((o = gs(o, i)), Mn(o) && (i = 0)),
                Rn(a) && a.hasChildNodes() && ((a = gs(a, t.collapsed ? u : u - 1)), Mn(a) && (u = a.nodeValue.length)),
                (o = bf(s, o)),
                (a = bf(s, a)),
                Af(o) && ((o = gf(o) ? o : o.parentNode), (o = t.collapsed ? o.previousSibling || o : o.nextSibling || o), Mn(o) && (i = t.collapsed ? o.length : 0)),
                Af(a) && ((a = gf(a) ? a : a.parentNode), (a = t.collapsed ? a.nextSibling || a : a.previousSibling || a), Mn(a) && (u = t.collapsed ? 0 : a.length)),
                t.collapsed &&
                    (Sf(s, e.getBody(), o, i, !0, r).each(function (e) {
                        var t = e.container,
                            n = e.offset;
                        (o = t), (i = n);
                    }),
                ...
                (n[0].inline || n[0].block_expand) && ((n[0].inline && Mn(o) && 0 !== i) || (o = _f(s, n, o, i, !0)), (n[0].inline && Mn(a) && u !== a.nodeValue.length) || (a = _f(s, n, a, u, !1))),
                n[0].selector && !1 !== n[0].expand && !n[0].inline && ((o = Nf(s, n, t, o, "previousSibling")), (a = Nf(s, n, t, a, "nextSibling"))),
                (n[0].block || n[0].selector) && ((o = Ef(e, n, o, "previousSibling")), (a = Ef(e, n, a, "nextSibling")), n[0].block && (s.isBlock(o) || (o = _f(s, n, o, i, !0)), s.isBlock(a) || (a = _f(s, n, a, u, !1)))),
                Rn(o) && ((i = s.nodeIndex(o)), (o = o.parentNode)),
                Rn(a) && ((u = s.nodeIndex(a) + 1), (a = a.parentNode)),
        ...
        Ff = function (o, e) {
            return as(
                ((a = (i = e).startContainer), (u = i.startOffset), Mn(a) ? (0 === u ? U.some(Rt.fromDom(a)) : U.none()) : U.from(a.childNodes[u]).map(Rt.fromDom)),
                ((n = (t = e).endContainer), (r = t.endOffset), Mn(n) ? (r === n.data.length ? U.some(Rt.fromDom(n)) : U.none()) : U.from(n.childNodes[r - 1]).map(Rt.fromDom)),
                function (e, t) {
                    var n = W(If(o), N(Bt, e)),
                        r = W(Mf(o), N(Bt, t));
        ...
        Xf = function (u, s, c, l) {
            u.undoManager.transact(function () {
                var e,
                    ...
                    i = o.getRng(),
                    a = 0 < Lf(u).length;
                i.collapsed && !a && ((n = Rf((e = u), (t = i), [{ inline: !0 }])), t.setStart(n.startContainer, n.startOffset), t.setEnd(n.endContainer, n.endOffset), e.selection.setRng(t)),
                    o.getRng().collapsed && !a
                        ? ((r = Wf(u.getDoc(), l, s, c.decorate)), es(r, fo), o.getRng().insertNode(r.dom), o.select(r.dom))
                        : Hf(o, !1, function () {
                              jf(u, function (e) {
    ...
    var Jf = function (e, t) {
        ...
        nd = function (r, l) {
            var f,
                ...
                D = Math.round,
                O = l.getBody(),
                B = { nw: [0, 0, -1, -1], ne: [1, 0, 1, -1], se: [1, 1, 1, 1], sw: [0, 1, -1, 1] },
                P = function (e) {
                ...
                U = function (e) {
                    ...
                    (w = s * p[2] + v),
                        ...
                        (w = w < 5 ? 5 : w),
                        (x = x < 5 ? 5 : x),
                        ((P(f) || L(f)) && !1 !== l.getParam("resize_img_proportional", !0, "boolean") ? !ed.modifierPressed(e) : ed.modifierPressed(e)) && (T(s) > T(c) ? ((x = D(w * b)), (w = D(x / b))) : ((w = D(x / b)), (x = D(w * b)))),
                        F(d, w, x),
                        (t = 0 < (t = p.startPos.x + s) ? t : 0),
                        (n = 0 < (n = p.startPos.y + c) ? n : 0),
                        k.setStyles(m, { left: t, top: n, display: "block" }),
                        (m.innerHTML = w + " &times; " + x),
                        p[2] < 0 && d.clientWidth <= w && k.setStyle(d, "left", void 0 + (v - w)),
                        p[3] < 0 && d.clientHeight <= x && k.setStyle(d, "top", void 0 + (y - x)),
                        (s = O.scrollWidth - S) + (c = O.scrollHeight - N) !== 0 && k.setStyles(m, { left: t - s, top: n - c }),
                ...
                z = function () {
                    var e,
                        ...
                        i = C;
                    (C = !1),
                        i && (a(f, "width", w), a(f, "height", x)),
                        k.unbind(A, "mousemove", U),
                        k.unbind(A, "mouseup", z),
                        R !== A && (k.unbind(R, "mousemove", U), k.unbind(R, "mouseup", z)),
                        k.remove(d),
                        k.remove(m),
                        k.remove(c),
                        u(f),
                        i && ((e = l), (t = f), (n = w), (r = x), (o = "corner-" + p.name), e.fire("ObjectResized", { target: t, width: n, height: r, origin: o }), k.setAttrib(f, "style", k.getAttrib(f, "style"))),
                        l.nodeChanged();
                },
                u = function (e) {
                    H();
                        ...
                        ? _(B, function (r, o) {
                              var t = function (e) {
                                      ...
                                      (g = e.screenX),
                                          ...
                                          (b = y / v),
                                          ((p = r).name = o),
                                          (p.startPos = { x: u * r[0] + i, y: s * r[1] + a }),
                                          (S = O.scrollWidth),
                                          (N = O.scrollHeight),
                                          (c = k.add(O, "div", { class: "mce-resize-backdrop" })),
                                          k.setStyles(c, { position: "fixed", left: "0", top: "0", width: "100%", height: "100%" }),
                                          (d = L((t = f)) ? k.create("img", { src: xt.transparentSrc }) : t.cloneNode(!0)),
                                          k.addClass(d, "mce-clonedresizable"),
                                          k.setAttrib(d, "data-mce-bogus", "all"),
                                          (d.contentEditable = "false"),
                                          k.setStyles(d, { left: i, top: a, margin: 0 }),
                                          F(d, u, s),
                                          d.removeAttribute(E),
                                          O.appendChild(d),
                                          k.bind(A, "mousemove", U),
                                          k.bind(A, "mouseup", z),
                                          R !== A && (k.bind(R, "mousemove", U), k.bind(R, "mouseup", z)),
                                          (m = k.add(O, "div", { class: "mce-resize-helper", "data-mce-bogus": "all" }, v + " &times; " + y));
                                  },
                                  e = k.get("mceResizeHandle" + o);
                              e && k.remove(e),
                                  (e = k.add(O, "div", { id: "mceResizeHandle" + o, "data-mce-bogus": "all", class: "mce-resizehandle", unselectable: !0, style: "cursor:" + o + "-resize; margin:0; padding:0" })),
                                  11 === xt.ie && (e.contentEditable = !1),
                                  k.bind(e, "mousedown", function (e) {
                                      e.stopImmediatePropagation(), e.preventDefault(), t(e);
                                  }),
                                  (r.elm = e),
                                  k.setStyles(e, { left: u * r[0] + i - e.offsetWidth / 2, top: s * r[1] + a - e.offsetHeight / 2 });
                          })
                        : j(),
                        k.getAttrib(f, E) || f.setAttribute(E, o);
                },
                j = function () {
                    H(),
                ...
                o = function (e) {
                    ...
                    C ||
                        l.removed ||
                        (_(k.select("img[data-mce-selected],hr[data-mce-selected]"), function (e) {
                            e.removeAttribute(E);
                        }),
                        (t = "mousedown" === e.type ? e.target : r.getNode()),
                        n((t = k.$(t).closest("table,img,figure.image,hr,video,span.mce-preview-object")[0]), O) && (s(), n(r.getStart(!0), t) && n(r.getEnd(!0), t)) ? u(t) : j());
                },
                i = function (e) {
                ...
                try {
                    ...
                    r = (function (e, n, t) {
                        ...
                        if (
                            ...
                            0 <
                                (r = (r = _t.toArray(i.getClientRects())).sort(function (e, t) {
        ...
        md = function (e) {
            ...
            return (
                t === r && Mn(t)
                    ? 0 < n && n < t.nodeValue.length && ((t = (r = dd(t, n)).previousSibling), n < o ? ((t = r = dd(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0)) : (o = 0))
                    : (Mn(t) && 0 < n && n < t.nodeValue.length && ((t = dd(t, n)), (n = 0)), Mn(r) && 0 < o && o < r.nodeValue.length && (o = (r = dd(r, o).previousSibling).nodeValue.length)),
    ...
    var gd,
        ...
        Sd = function (e) {
            var t,
                n,
                r,
                o = Rt.fromDom(document),
                i = xn(o),
                a = ((t = e), (r = (n = xd).owner(t)), wd(n, r)),
                u = wn(e),
                s = q(
                    a,
                    function (e, t) {
            ...
            var n,
                r = (function (e) {
                    ...
                    var i = Cn(null == r ? void 0 : r.pageYOffset, o.scrollTop),
                        a = Cn(null == r ? void 0 : r.pageXOffset, o.scrollLeft),
                        u = Cn(o.clientTop, n.clientTop),
        ...
        kd = function (e, t) {
            var n = (function (e, t) {
                    ...
                    var r = n[n.length - 1];
                    return Nd(r) ? { element: e, offset: t } : "img" === It(r) ? { element: r, offset: 1 } : zt(r) ? { element: r, offset: qf(r).length } : { element: r, offset: Jt(r).length };
                })(e, t),
                r = Rt.fromHtml('<span data-mce-bogus="all">\ufeff</span>');
            return (
                cn(n.element, r),
                Ed(r, function () {
                    return gn(r);
        ...
        Rd = function (e, t, n, r) {
            var o = Rt.fromDom(e.getBody()),
                i = Rt.fromDom(e.getDoc());
            o.dom.offsetWidth;
        ...
        um = function (r) {
            ...
            r.on("init", function () {
                ...
                r.inline &&
                    ...
                    xu.DOM.bind(document, "mouseup", n),
                ...
                n = function (f, e) {
                    ...
                    for (
                        var t,
                            ...
                            N = 0,
                            E = li.decode,
                            k = _t.makeMap("src,href,data,background,action,formaction,poster,xlink:href"),
                        ...
                        if ((x < t.index && T(E(w.substr(x, t.index - x))), (i = t[7]))) ":" === (i = i.toLowerCase()).charAt(0) && (i = i.substr(1)), R(i);
                            ...
                            if (!U || (s = K.getElementRule(i))) {
                                if (
                                    ...
                                    if (((v = s.attributesRequired), (y = s.attributesDefault), (b = s.attributesForced), s.removeEmptyAttrs && !d.length && (c = !1), b))
                                        for (r = b.length; r--; ) (a = (l = b[r]).name), "{$uid}" === (C = l.value) && (C = "mce_" + N++), (d.map[a] = C), d.push({ name: a, value: C });
                                    if (y) for (r = y.length; r--; ) (a = (l = y[r]).name) in d.map || ("{$uid}" === (C = l.value) && (C = "mce_" + N++), (d.map[a] = C), d.push({ name: a, value: C }));
                                    if (v) {
                            ...
                            if ((n = H[i])) {
                                (n.lastIndex = x = t.index + q.length),
                                    (x = (t = n.exec(w)) ? (c && (o = w.substr(x, t.index - x)), t.index + t[0].length) : ((o = w.substr(x)), w.length)),
    ...
    var Lm,
        ...
        Um = function (e, t, n, r) {
            ...
            return (
                ...
                (o =
                    "raw" === t.format
                        ? _t.trim(Fm(e.serializer, r.innerHTML))
                        : "text" === t.format
                        ? e.dom.isEmpty(r)
                            ? ""
                            : go(r.innerText || r.textContent)
                        : "tree" === t.format
                        ? e.serializer.serialize(r, t)
                        : ((a = (i = e).serializer.serialize(r, t)), (u = lc(i)), (s = new RegExp("^(<" + u + "[^>]*>(&nbsp;|&#160;|\\s|\xa0|<br \\/>|)<\\/" + u + ">[\r\n]*|<br \\/>[\r\n]*)$")), a.replace(s, ""))),
                M(["text", "tree"], t.format) || co(Rt.fromDom(r)) ? (t.content = o) : (t.content = _t.trim(o)),
        ...
        Vm = function (e) {
            var u = [],
                ...
                l = Hm(e.indent_after || ""),
                f = li.getEncodeFunc(e.entity_encoding || "raw", e.entities),
        ...
        wp = function (e, t, n) {
            var r = H(fp(Rt.fromDom(n.container()), t), to),
                o = re(r).getOr(t);
        ...
        Fp = function (l, e) {
            return U.some(e)
                ...
                .bind(function (e) {
                    ...
                    (u = (a = c).data),
                    (s = Is(a, 0)),
                    !(!Lp(u, 0) || Pp(i, s) || ((a.data = " " + u.slice(1)), 0)) || Mp(c) || ((t = l), (r = (n = c).data), (o = Is(n, r.length - 1)), !(!Lp(r, r.length - 1) || Pp(t, o) || ((n.data = r.slice(0, -1) + " "), 0))))
                        ? U.some(e)
                        : U.none();
                });
        },
        Up = function (t) {
            ...
            t.selection.isCollapsed() &&
                Fp(e, Is.fromRangeStart(t.selection.getRng())).each(function (e) {
        ...
        zp = function (e, t, n) {
            ...
            0 !== n &&
                ...
                (a = t + n >= e.data.length && Bp(o, Is(e, e.data.length))),
                (u = 0 === t && Op(o, Is(e, 0))),
                e.replaceData(
                    t,
                    n,
                        ...
                        function (e, t) {
                            return Gl(t) || Yl(t)
                                ? e.previousCharIsSpace || ("" === e.str && c) || (e.str.length === s.length - 1 && l)
                                    ? { previousCharIsSpace: !1, str: e.str + fo }
            ...
            return $p(o)
                ...
                .orThunk(function () {
                    return (
                        (e = r),
                        (t = o),
                        (n = Is.before(t.previousSibling ? t.previousSibling : t.parentNode)),
                        Pl(e, n).fold(function () {
        ...
        Xp = function (n, r) {
            return Wp(r)
                ...
                .orThunk(function () {
                    return (
                        (t = r),
                        Bl((e = n), Is.after(t)).fold(function () {
        ...
        sg = function (r, e) {
            var t = rg(e.startContainer, r),
                n = rg(e.endContainer, r);
            return e.collapsed
                ? U.none()
                : as(t, n, tg).fold(
                      function () {
                      ...
                      function (e) {
                          return cg(r, e)
                              ? U.none()
                              : ((n = r),
                                og((t = e).start, n).bind(function (e) {
                                    return oe(ug(e)).map(function (e) {
                                        return tg(t.start, e);
                                    });
                                }));
        ...
        gg = function (e) {
            var t;
            return (8 === Mt((t = e)) || "#comment" === It(t) ? Kt : en)(e)
                .bind(gg)
                .orThunk(function () {
                    return U.some(e);
                });
        ...
        vg = function (e, t, n) {
            ...
            var r,
                o,
                i = gg(n).getOr(n),
                a = Rt.fromDom(e.dom.getParent(i.dom, e.dom.isBlock));
            return (
                Wo(a) && (up(a), e.selection.setCursorLocation(a.dom, 0)),
                Bt(n, a) ||
                    ((r = Wt(a).is(n)
                        ? []
                        : Wt((o = a))
                ...
                .bind(function (e) {
                    return (
                        ...
                        Ll((r = l).dom)
                            ...
                            : ((t = l),
                              (n = e),
                              wg(s, Rt.fromDom(n.getNode())).map(function (e) {
                                  return !1 === Bt(e, t);
                              }))
                    );
                    var t, n, r, o, i, a;
                ...
                .bind(function (e) {
                    return Wo(e)
                        ...
                        : ((t = a),
                          (n = e),
                          (r = u),
                          Tl(i, o.getBody(), r).bind(function (e) {
            ...
            return wg(s, r).fold(
                function () {
                    return (
                        ...
                        ((e = a),
                        (t = u),
                        (n = Is.fromRangeStart(e.selection.getRng())),
                        Eg(t, n) ||
                            Rl(t, e.getBody(), n).exists(function (e) {
                                return Eg(t, e);
                            }))
                    );
                    var e, t, n;
        ...
        _g = function (e, t) {
            var n,
                ...
                i,
                a,
                u = Rt.fromDom(e.selection.getStart(!0)),
                s = Lf(e);
        ...
        Ig = function (t, e, n) {
            var r,
                ...
                u = t.parentNode;
            return (
                _t.each(e, function (e) {
                    u.insertBefore(e, t);
                }),
                (r = t),
                (o = n),
                (i = Is.before(r)),
                (a = Nl(o).next(i)) ? a.toRange() : null
            );
        },
        Mg = function (e, o, i, t) {
            var n,
                ...
                N =
                    ...
                    a),
                E = Pg(o, i.startContainer),
                k = Bg(
                    ((f = N.firstChild),
                    _t.grep(f.childNodes, function (e) {
                        return "LI" === e.nodeName;
                    }))
                ),
                _ = o.getRoot(),
                A = function (e) {
                    var t = Is.fromRangeStart(i),
                        n = Nl(o.getRoot()),
            ...
            return A(1)
                ? Ig(E, k, _)
                : A(2)
                ? ((d = E), (m = k), (p = _), o.insertAfter(m.reverse(), d), Lg(m[0], p))
                : ((h = k),
                  (v = _),
                  (y = g = E),
                  (C = (b = i).cloneRange()),
        ...
        Ug = function (e) {
            var t = e.dom,
                n = Rg(e.selection.getRng());
            e.selection.setRng(n);
            var r,
                o,
                i,
                a = t.getParent(n.startContainer, Fg);
        ...
        zg = function (e, t, n) {
            ...
            /^ | $/.test(t) &&
                ...
                (c = d.getRng()),
                (l = t),
                (f = Rt.fromDom(s.getRoot())),
                (l = Op(f, Is.fromRangeStart(c)) ? l.replace(/^ /, "&nbsp;") : l.replace(/^&nbsp;/, " ")),
                (t = l = Bp(f, Is.fromRangeEnd(c)) ? l.replace(/(&nbsp;| )(<br( \/)>)?$/, "&nbsp;") : l.replace(/&nbsp;(<br( \/)?>)?$/, " ")));
            var p = e.parser,
                g = n.merge,
                h = qm({ validate: e.getParam("validate") }, e.schema),
            ...
            if ((y = e.fire("BeforeSetContent", y)).isDefaultPrevented()) e.fire("SetContent", { content: y.content, format: "html", selection: !0, paste: n.paste });
                ...
                (R = g),
                    ...
                    R &&
                        ((T = A.getBody()),
                        (D = jm(B)),
                        _t.each(B.select("*[data-mce-fragment]"), function (e) {
                    ...
                    (P = e.getBody()),
                    _t.each(P.getElementsByTagName("*"), function (e) {
                        e.removeAttribute("data-mce-fragment");
                    }),
                    (L = m),
                    (I = d.getStart()),
                    U.from(L.getParent(I, "td,th")).map(Rt.fromDom).each(sp),
                    e.fire("SetContent", y),
                    e.addVisual();
            }
        },
        ...
        qg = function (e, t) {
            ...
            e.dom.setHTML(e.getBody(), t),
                vm((r = e)) &&
                    Ll(r.getBody()).each(function (e) {
                        var t = e.getNode(),
                            n = Pn(t) ? Ll(t).getOr(e) : e;
        ...
        $g = function (u, s, c) {
            return (
                ...
                Vg(s) || (s = c.content),
                U.from(u.getBody()).fold(S(s), function (e) {
                    return Vg(s)
                        ? (function (e, t, n, r) {
                        ...
                        : ((t = u),
                          ...
                          0 === (r = s).length || /^\s+$/.test(r)
                              ? ((a = '<br data-mce-bogus="1">'),
                                ...
                                (r = (i = lc(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase()) ? ((r = a), t.dom.createHTML(i, fc(t), r)) : r || '<br data-mce-bogus="1">'),
                                qg(t, r),
                                t.fire("SetContent", o))
                              : ("raw" !== o.format && (r = qm({ validate: t.validate }, t.schema).serialize(t.parser.parse(r, { isRootContent: !0, insert: !0 }))),
                                (o.content = co(Rt.fromDom(n)) ? r : _t.trim(r)),
                                qg(t, o.content),
        ...
        Wg = function (e, t) {
            return (
                ...
                ((o = (n = e).dom).parentNode
                    ? Or(Rt.fromDom(o.parentNode), function (e) {
                          return !Bt(n, e) && r(e);
                      })
                    : U.none()
                ).isSome()
        ...
        eh = function (e, t, n, r, o) {
            ...
            if (c && t)
                for (a = 0; a < c.length; a++)
                    if (((i = c[a]), Qg(e.dom, t, i) && Zg(l, t, i, "attributes", o, r) && Zg(l, t, i, "styles", o, r))) {
        ...
        ch = function (e, t, n) {
            ...
            ah(t)
                ...
                : ((r = d.getRng()),
                  ...
                  (u = r.endContainer),
                  (s = r.endOffset),
                  (l = uh(t)) && l.nodeValue.charAt(0) === oh && l.deleteData(0, 1),
                  (c = l),
                  f.remove(t, !0),
                  i === c && 0 < a && r.setStart(c, a - 1),
                  u === c && 0 < s && r.setEnd(c, s - 1),
                  o && f.isEmpty(o) && up(Rt.fromDom(o)),
                  d.setRng(r));
        },
        lh = function (e, t, n) {
            void 0 === n && (n = !0);
            var r = e.dom,
                o = e.selection;
            if (t) ch(e, t, n);
            else if (!(t = Ul(e.getBody(), o.getStart()))) for (; (t = r.get(ih)); ) ch(e, t, !1);
        },
        fh = function (e, t) {
        ...
        mh = function (e, t, n, r) {
            ...
            i &&
                (o
                    ? ((a = y.getBookmark()), C.collapse(!0), (u = Rf(e, C, e.formatter.get(t), !0)), (u = md(u)), e.formatter.remove(t, n, u, r), y.moveToBookmark(a))
                    : ((s = Ul(e.getBody(), i)),
                      (c = sh(!1).dom),
                      (m = c),
                      (p = null !== s ? s : i),
                      (g = (d = e).dom),
                      (h = g.getParent(p, N(tf, d))) && g.isEmpty(h) ? p.parentNode.replaceChild(m, p) : (ap(Rt.fromDom(p)), g.isEmpty(p) ? p.parentNode.replaceChild(m, p) : g.insertAfter(m, p)),
        ...
        ph = function (i) {
            i.on("mouseup keydown", function (e) {
                ...
                (t = i),
                    ...
                    (o = t.getBody()),
                    lh(t, null, !1),
                    (8 !== n && 46 !== n) || !r.isCollapsed() || r.getStart().innerHTML !== oh || lh(t, Ul(o, r.getStart())),
                    (37 !== n && 39 !== n) || lh(t, Ul(o, r.getStart()));
            });
        },
        gh = function (e, t) {
    ...
    var bh = _t.each,
        ...
        xh = function (e, t, n) {
            ...
            if (t && n && ((t = wh(t, "previousSibling")), (n = wh(n, "nextSibling")), i.compare(t, n))) {
                ...
                return (
                    e.remove(n),
                    _t.each(_t.grep(n.childNodes), function (e) {
                        t.appendChild(e);
                    }),
                    t
                );
        ...
        _h = wr([{ keep: [] }, { rename: ["name"] }, { removed: [] }]),
        Ah = /^(src|href|style)$/,
        Rh = _t.each,
        Th = af,
        Dh = function (e, t, n) {
        ...
        Oh = function (e, t, n) {
            ...
            return (
                Rn(o) && ((r = o.childNodes.length - 1), !n && i && i--, (o = o.childNodes[r < i ? r : i])),
                Mn(o) && n && i >= o.nodeValue.length && (o = new Yr(o, e.getBody()).next() || o),
                Mn(o) && !n && 0 === i && (o = new Yr(o, e.getBody()).prev() || o),
                o
            );
        },
        Bh = function (e, t) {
            ...
            return "none" !== r.remove
                ? ((f = e),
                  ...
                  m.block &&
                      (v
                          ? g === h.getRoot() &&
                            ((m.list_block && Th(d, m.list_block)) ||
                                Y(ie(d.childNodes), function (e) {
                                    nf(f, v, e.nodeName.toLowerCase()) ? (p ? p.appendChild(e) : ((p = Ph(h, e, v)), h.setAttribs(p, f.settings.forced_root_block_attrs))) : (p = 0);
                                }))
                          : h.isBlock(d) && !h.isBlock(g) && (Ih(h, d, !1) || Ih(h, d.firstChild, !0, !0) || d.insertBefore(h.create("br"), d.firstChild), Ih(h, d, !0) || Ih(h, d.lastChild, !1, !0) || d.appendChild(h.create("br")))),
                  (m.selector && m.inline && !Th(m.inline, d)) || h.remove(d, !0),
                  _h.removed())
                : _h.keep();
        },
        Fh = function (t, e, n, r, o) {
            return Mh(t, e, n, r, o).fold(
                b,
                function (e) {
        ...
        zh = function (s, c, l, e, f) {
            var t,
                ...
                u = function (e) {
                    var n,
                        ...
                        u =
                            ...
                            (o = l),
                            (i = f),
                            Y(lf((n = s).dom, t.parentNode).reverse(), function (e) {
                                var t;
                ...
                g = function (e) {
                    ...
                    return (
                        Xl((t = r)) && Rn(t) && ("_start" === t.id || "_end" === t.id) && (r = r[e ? "firstChild" : "lastChild"]),
                        Mn(r) && 0 === r.data.length && (r = e ? n.previousSibling || n.nextSibling : n.nextSibling || n.previousSibling),
                        a.remove(n, !0),
                        r
                    );
                },
                r = function (e) {
                    ...
                    if (m.split) {
                        if (((r = md(r)), (t = Oh(s, r, !0)) !== (n = Oh(s, r)))) {
                            ...
                            (t = Ph(a, t, "span", { id: "_start", "data-mce-type": "bookmark" })), (n = Ph(a, n, "span", { id: "_end", "data-mce-type": "bookmark" }));
                            var i = a.createRng();
                            i.setStartAfter(t),
                                i.setEndBefore(n),
                                Df(a, i, function (e) {
                    ...
                    Df(a, r, function (e) {
                        Y(e, function (t) {
                            ...
                            Y(["underline", "line-through", "overline"], function (e) {
                                Rn(t) && s.dom.getStyle(t, "text-decoration") === e && t.parentNode && cf(a, t.parentNode) === e && Fh(s, { deep: !1, exact: !0, inline: "span", styles: { textDecoration: e } }, null, t);
                            });
                        });
                    });
                };
            if (e) Ql(e) ? ((t = a.createRng()).setStartBefore(e), t.setEndAfter(e), r(t)) : r(e);
            else if ("false" !== a.getContentEditable(n.getNode()))
                n.isCollapsed() && m.inline && !Lf(s).length
                    ? mh(s, c, l, f)
                    : (Hf(n, !0, function () {
                          jf(s, r);
                      }),
                      m.inline && th(s, c, l, n.getStart()) && Zl(a, n, n.getRng()),
                      s.nodeChanged());
            else {
                e = n.getNode();
        ...
        $h = function (E, k, _, r) {
                ...
                T = function (n, e) {
                    ...
                    (e = e || R),
                        n &&
                            ...
                            Vh(e.styles, function (e, t) {
                                a.setStyle(n, t, of(e, _));
                            }),
                            !e.styles || ((t = a.getAttrib(n, "style")) && a.setAttrib(n, "data-mce-style", t)),
                            Vh(e.attributes, function (e, t) {
                    ...
                    T(d),
                        Df(S, e, function (e) {
                            var u,
                                s = function (e) {
                                    ...
                                    if (
                                        (Rn(e) && S.getContentEditable(e) && ((n = l), (l = "true" === S.getContentEditable(e)), (t = !0)),
                                        jn(e) &&
                                            !(function (e, t, n, r) {
                                        ...
                                        return (u = null), void (df(R) && S.remove(e));
                                    if (R.wrapper && eh(E, e, k, _)) u = null;
                                    else {
                                        ...
                                        !l || t || !nf(E, f, r) || !nf(E, o, f) || (!c && 3 === e.nodeType && 1 === e.nodeValue.length && 65279 === e.nodeValue.charCodeAt(0)) || Fl(e) || (qh(R, "inline") && S.isBlock(e))
                                            ? ((u = null), Vh(_t.grep(e.childNodes), s), t && (l = n), (u = null))
                        ...
                        Vh(N, function (e) {
                            ...
                            (!(1 < N.length) && S.isBlock(e)) || 0 !== x
                                ? (pf(R) || R.wrapper) &&
                                  (R.exact || 1 !== x || ((C = w((y = e))) && !Xl(C) && Qg(S, C, R) && ((b = S.clone(C, !1)), T(b), S.replace(b, y, !0), S.remove(C, !0)), (e = b || y)),
                                  Hh(E, A, _, e),
                                  (p = R),
                                  (g = k),
                                  (h = _),
                                  (eh((m = E), (v = e).parentNode, g, h) && Fh(m, p, h, v)) ||
                                  ...
                                  (f = _),
                                  (d = e),
                                  (l = R).styles && l.styles.backgroundColor && Nh(d, Eh(c, "fontSize"), kh(c, "backgroundColor", of(l.styles.backgroundColor, f))),
                                  (i = S),
                                  (u = e),
                                  (s = function (e) {
                                      var t;
                                      1 === e.nodeType &&
                                          ...
                                          ((t = cf(i, e.parentNode)), i.getStyle(e, "color") && t ? i.setStyle(e, "text-decoration", t) : i.getStyle(e, "text-decoration") === t && i.setStyle(e, "text-decoration", null));
                                  }),
                                  (a = R).styles && (a.styles.color || a.styles.textDecoration) && (_t.walk(u, s, "childNodes"), s(u)),
                                  (t = S),
                                  (o = e),
                                  ("sub" !== (r = R).inline && "sup" !== r.inline) || (Nh(o, Eh(t, "fontSize"), kh(t, "fontSize", "")), t.remove(t.select("sup" === r.inline ? "sub" : "sup", o), !0)),
                                  Sh(S, R, 0, e))
                                : S.remove(e, !0);
                        });
                };
            if ("false" !== a.getContentEditable(u.getNode())) {
                R &&
                    (r
                        ? Ql(r)
                            ? m(A, r) || ((e = a.createRng()).setStartBefore(r), e.setEndAfter(r), s(a, Rf(E, e, A), 0, !0))
                            : s(a, r, 0, !0)
                        : i && pf(R) && !Lf(E).length
                        ? (function (e, t, n) {
                              var r,
                              ...
                              u && 0 < a && a < u.length && m.test(u.charAt(a)) && m.test(u.charAt(a - 1))
                                  ? ((c = o.getBookmark()), i.collapse(!0), (l = Rf(e, i, e.formatter.get(t))), (l = md(l)), e.formatter.apply(t, n, l), o.moveToBookmark(c))
                                  : ((s && r.nodeValue === oh) || ((f = e.getDoc()), (d = sh(!0).dom), (r = (s = f.importNode(d, !0)).firstChild), i.insertNode(s), (a = 1)), e.formatter.apply(t, n, s), o.setCursorLocation(r, a));
                          })(E, k, _)
                        : ((t = u.getNode()),
                          (n = A[0]),
                          E.settings.forced_root_block || !n.defaultBlock || a.getParent(t, a.isBlock) || $h(E, n.defaultBlock),
                          u.setRng(Rg(u.getRng())),
                          Hf(u, !0, function (e) {
                              jf(E, function (e, t) {
                                  var n = t ? e : Rf(E, e, A);
                                  s(a, n);
        ...
        ev = function (e, t) {
            for (var n = e.rows, r = 0; r < n.length; r++) for (var o = n[r].cells, i = 0; i < o.length; i++) if (Bt(o[i], t)) return U.some({ x: i, y: r });
            return U.none();
        },
        ...
        iv = function (t, n) {
            return W(t, function (e) {
                ...
                return W(t, function (e) {
                    ...
                    .map(function (e) {
                        var t = Rt.fromTag(It(e)),
                            n = pe(or(e), function (e, t) {
        ...
        av = function (e, t) {
            var n,
                r = Rt.fromDom(t.commonAncestorContainer),
                o = fp(r, e),
                i = H(o, function (e) {
                    return no(e) || eo(e);
                }),
            ...
            return U.from(f.selection.getRng())
                .map(function (e) {
                    var t = U.from(f.dom.getParent(e.commonAncestorContainer, f.dom.isBlock)),
                        ...
                        i = f.dom.add(n, r, { "data-mce-bogus": "all", style: "overflow: hidden; opacity: 0;" }, e.cloneContents()),
                        a = dv(i, o),
                        u = go(i.textContent);
        ...
        pv = function (e, t, n) {
            ...
            var r,
                ...
                l =
                    ...
                    (s = Nm(r, Of(u))),
                    (c = o.contextual ? lv(Rt.fromDom(r.getBody()), s).dom : i.cloneContents()) && a.appendChild(c),
        ...
        Cv = function (n) {
            var e,
                t =
                    ((e = n.getBody()),
                    H(z(ie(e.childNodes), gv), function (e) {
                        return 0 < e.length;
                    })),
                r = J(t, function (e) {
                    ...
                    canApply: function (e) {
                        return (function (e, t) {
                            var n,
                                ...
                                s = e.dom;
                            if (u)
                                for (n = e.selection.getStart(), r = lf(s, n), i = u.length - 1; 0 <= i; i--) {
                ...
                editor: {
                    getContent: function (e, t) {
                        return (
                            ...
                            (r = e),
                            (o = t),
                            U.from(n.getBody()).fold(S("tree" === r.format ? new Am("body", 11) : ""), function (e) {
                                return Um(n, r, o, e);
                            })
                        );
                        var n, r, o;
                    ...
                    addVisual: function (e) {
                        return (
                            ...
                            (a = (i = f).dom),
                            (n = V(t) ? t : i.getBody()),
                            T(i.hasVisual) && (i.hasVisual = i.getParam("visual", !0, "boolean")),
                            ...
                            function (e) {
                                ...
                                return (
                                    (c.rtcInstance =
                                        ...
                                        (n = m("Unimplemented feature for rtc")),
                                        (i = (t = e).undoManager),
                                        (a = t.formatter),
                                        (r = t.editor),
                                        (u = t.selection),
                            ...
                            function (e) {
                                ...
                                return (
                                    (c.rtcInstance =
                                        ...
                                        (n = S("")),
                                        {
                                            undoManager: { beforeChange: te, addUndoLevel: t, undo: t, redo: t, clear: te, reset: te, hasUndo: b, hasRedo: b, transact: t, ignore: te, extra: te },
                                            formatter: { match: b, matchAll: S([]), matchNode: b, canApply: b, closest: n, apply: te, remove: te, toggle: te, formatChanged: S({ unbind: te }) },
        ...
        Lv = function (e, t, s, c) {
            e.bind(function (u) {
                return (
                    (c ? Hp : jp)(u.dom, c ? u.dom.length : 0),
                    t.filter(zt).map(function (e) {
                ...
                t
                    ...
                    .bind(e ? Xt : Kt)
                    .or(t)
                    .filter(zt)).map(function (e) {
                    return (
                        (r = c),
                        void Wt((n = e)).each(function (e) {
                            var t = n.dom;
        ...
        Iv = function (e, t, n) {
            ...
            var r,
                o,
                i = ((r = t), _e(_e({ format: "html" }, n), { set: !0, selection: !0, content: r }));
            i.no_events || !(i = e.fire("BeforeSetContent", i)).isDefaultPrevented()
                ? ((n.content = (function (e, t) {
                  ...
                  (function (e, t) {
                      var n = U.from(t.firstChild).map(Rt.fromDom),
                          r = U.from(t.lastChild).map(Rt.fromDom);
                      e.deleteContents(), e.insertNode(t);
                      var o = n.bind(Kt).filter(zt).bind(Pv),
                          i = r.bind(Xt).filter(zt).bind(Pv);
    ...
    var Fv,
                    ...
                    getNode: function () {
                        return (function (e, t) {
                            ...
                            return !t.collapsed &&
                                ...
                                3 === n.nodeType && 3 === r.nodeType && ((n = n.length === o ? Sm(n.nextSibling, !0) : n.parentNode), (r = 0 === i ? Sm(r.previousSibling, !1) : r.parentNode), n && n === r))
                                ? n
                                : a && 3 === a.nodeType
                                ? a.parentNode
                                : a;
                    ...
                    getSelectedBlocks: function (e, t) {
                        return (function (e, t, n, r) {
                            var o,
                                i = [],
                                a = e.getRoot();
                            if (((n = e.getParent(n || wm(a, t, t.collapsed), e.isBlock)), (r = e.getParent(r || xm(a, t, t.collapsed), e.isBlock)), n && n !== a && i.push(n), n && r && n !== r))
                                for (var u = new Yr((o = n), a); (o = u.next()) && o !== r; ) e.isBlock(o) && i.push(o);
        ...
        qv = function (e, t) {
            var n,
                r = xi();
            t.convert_fonts_to_spans && Vv(e, r, _t.explode(t.font_size_legacy_values)),
                (n = r),
        ...
        Jv = function (i, a) {
            ...
            return {
                findAll: function (e, n) {
                    n = n || w;
                    var t,
                        r = H((t = e) ? ie(t.getElementsByTagName("img")) : [], function (e) {
                            var t = e.src;
                            return (
                                xt.fileApi &&
                            ...
                            .filter(function () {
                                return (function (e, t) {
                                    if (t.images_dataimg_filter) {
                                        ...
                                        return (
                                            (n.src = e.attr("src")),
                                            se(e.attributes.map, function (e, t) {
                                                n.setAttribute(t, e);
                                            }),
            ...
            g.remove_trailing_brs &&
                e.addNodeFilter("br", function (e, t, n) {
                    var r,
                        ...
                        l,
                        f = e.length,
                        d = _t.extend({}, h.getBlockElements()),
            ...
            var e,
                ...
                n = {
                    ...
                    parse: function (e, u) {
                        ...
                        (u = u || {}), (O = {}), (B = {});
                        var f,
                            d = ay(ry("script,style,head,html,body,title,meta,param"), R.getBlockElements()),
                            ...
                            _ = (c = new Am(u.context || A.root_name, 11));
                        if (
                            (k.parse(e, u.format),
                            g &&
                                l.length &&
                                    ...
                                    : (function (e) {
                                          for (
                                              var t,
                                                  ...
                                                  c,
                                                  l,
                                                  f = ry("tr,td,th,tbody,thead,tfoot,table"),
                                        ...
                                        for (; n; )
                                            (e = n.next),
                                                3 === n.type || (1 === n.type && "p" !== n.name && !d[n.name] && !n.attr("data-mce-type"))
                                                    ? (t || ((t = N(v, 1)).attr(A.forced_root_block_attrs), _.insert(t, n)), t.append(n))
                                                    : (r(t), (t = null)),
                                                (n = e);
                                        r(t);
                                    }
                    ...
                    ? (function (e, t, n) {
                          ...
                          return (
                              s.createHTMLDocument &&
                                  ...
                                  _t.each("BODY" === t.nodeName ? t.childNodes : [t], function (e) {
                ...
                serialize: function (e, t) {
                    ...
                    var n,
                        ...
                        v =
                            ((a = x),
                            (u = h),
                            (d = (s = p).selection ? _e({ forced_root_block: !1 }, s) : s),
                            (m = a.parse(u, d)),
                            (l = function (e) {
                                return e && "br" === e.name;
                            }),
        ...
        vy = function (e) {
            ...
            e.removed ||
                ...
                e.hasHiddenInput && o && gy.remove(o.nextSibling),
                e.fire("remove"),
                e.editorManager.remove(e),
                !e.inline && r && ((i = e), gy.setStyle(i.id, "display", i.orgDisplay)),
                e.fire("detach"),
                gy.remove(e.getContainer()),
                hy(t),
                hy(n),
                e.destroy());
        },
        yy = function (e, t) {
            ...
            e.destroyed ||
                (t || e.removed
                    ? (t || (e.editorManager.off("beforeunload", e._beforeUnload), e.theme && e.theme.destroy && e.theme.destroy(), hy(i), hy(a)),
                      (r = (n = e).formElement) && (r._mceOldSubmit && ((r.submit = r._mceOldSubmit), (r._mceOldSubmit = null)), gy.unbind(r, "submit reset", n.formEventDelegate)),
        ...
        Sy = wy.isPhone(),
        Ny = wy.isTablet(),
        Ey = ["lists", "autolink", "autosave"],
        ky = { table_grid: !1, object_resizing: !1, resize: !1 },
        _y = function (e) {
            var t = _(e) ? e.join(" ") : e,
                n = z(K(t) ? t.split(" ") : [], We);
        ...
        Oy = function (e, t, n, r) {
            var o,
                i,
                a,
                u = _y(n.forced_plugins),
                s = _y(r.plugins),
                c = Ry((o = t), (i = "mobile")) ? o.sections()[i] : {},
                l = c.plugins ? _y(c.plugins) : s,
                f = Dy(e, t, s, l),
                d = ((a = f), [].concat(_y(u)).concat(_y(a)));
        ...
        By = function (e, t, n, r, o) {
            var i,
                ...
                l,
                f,
                d = e ? { mobile: ((i = o.mobile || {}), (a = t), (u = { resize: !1, toolbar_mode: Ty(i, "scrolling"), toolbar_sticky: !1 }), _e(_e(_e({}, ky), u), a ? { menubar: !1 } : {})) } : {},
                m = Ay(["mobile"], Cy(d, o)),
                p = _t.extend(
                    n,
                    r,
                    ...
                    e && Ry(f, "mobile")
                        ...
                        : {}),
                    { validate: !0, external_plugins: ((s = r), (c = m.settings()), (l = c.external_plugins ? c.external_plugins : {}), s && s.external_plugins ? _t.extend({}, s.external_plugins, l) : l) }
                );
            return Oy(e, m, r, p);
        },
        ...
        Iy = function (e, t, n, r) {
            ...
            return "hash" === r
                ? ((a = {}),
                  "string" == typeof (i = u)
                      ? Y(0 < i.indexOf("=") ? i.split(/[;,](?![^=;,]*(?:[;,]|$))/) : i.split(","), function (e) {
                            var t = e.split("=");
        ...
        qy = function (e, t, n) {
            var r,
                ...
                d,
                m,
                p = Rt.fromDom(e.getBody()),
                g = e.inline ? p : ((r = p), Rt.fromDom(qt(r).dom.documentElement)),
                h = ((o = e.inline), (a = t), (u = n), (s = (i = g).dom.getBoundingClientRect()), { x: a - (o ? s.left + i.dom.clientLeft + Vy(i) : 0), y: u - (o ? s.top + i.dom.clientTop + Hy(i) : 0) });
    ...
    var Yy,
        ...
        mb = function (s) {
            var n,
                ...
                g = function (e, t) {
                    ...
                    p(e.src, t), s.$(e).attr({ src: s.getParam("images_reuse_filename", !1, "boolean") ? (n = t) + (-1 === n.indexOf("?") ? "?" : "&") + new Date().getTime() : t, "data-mce-src": r });
                },
                h = function (n) {
                    return (
                        (r = r || db(s, a)),
                                            ...
                                            t = z(e, function (e, t) {
                                                ...
                                                return (
                                                    e.status && s.getParam("images_replace_blob_uris", !0, "boolean")
                                                        ? (c.removeByUri(i.src), g(i, e.url))
                                                        : e.error &&
                                                          (e.error.options.remove && (p(i.getAttribute("src"), xt.transparentSrc), a.push(i)), (n = s), (r = e.error.message), Zy(n, Ou.translate(["Failed to upload image: {0}", r]))),
                                                    { element: i, status: e.status, uploadUri: e.url, blobInfo: o }
                                                );
                                            });
                                        return (
                                            0 < t.length && l.fireIfChanged(),
                                            0 < a.length &&
                                                (Rv(s)
                ...
                b = function () {
                    return (o = o || Jv(a, c)).findAll(s.getBody(), y).then(
                        f(function (e) {
                            return (
                                (e = H(e, function (e) {
        ...
        pb = function (e) {
            var r,
                ...
                o = function (e, t) {
                    e &&
                        ("string" != typeof e
                            ? _t.each(e, function (e, t) {
                                  o(t, e);
                              })
                            : (_(t) || (t = [t]),
                              _t.each(t, function (e) {
            ...
            return (
                o(
                    ...
                    (t = {
                        ...
                        removeformat: [
                            { selector: "b,strong,em,i,font,u,strike,s,sub,sup,dfn,code,samp,kbd,var,cite,mark,q,del,ins", remove: "all", split: !0, expand: !1, block_expand: !0, deep: !0 },
            ...
            var n,
                ...
                g = function (n, e, t) {
                    ...
                    return (
                        ...
                        t &&
                            (r || (r = hb.create("div")).appendChild(n),
                            _t.each(t, function (e) {
                                var t = p(e);
                                r.insertBefore(t, n);
                            })),
                        ...
                        ? ((c = (c = c.split(/\s*,\s*/)[0]).replace(/\s*(~\+|~|\+|>)\s*/g, "$1")),
                          _t
                              .map(c.split(/(?:>|\s+(?![^\[\]]+\]))/), function (e) {
                                  var t = _t.map(e.split(/(?:~\+|~|\+)/), yb),
                                      n = t.pop();
                                  return t.length && (n.siblings = t), n;
                              })
                              .reverse())
                        : [],
                f = l.length ? (l[0].name || (l[0].name = t), (t = e.selector), vb(l, n)) : vb([t], n),
                d = hb.select(t, f)[0] || f.firstChild;
            return (
                gb(e.styles, function (e, t) {
                    var n = u(e);
                    n && hb.setStyle(d, t, n);
                }),
                ...
                hb.setStyles(f, { position: "absolute", left: -65535 }),
                n.getBody().appendChild(f),
                (r = hb.getStyle(n.getBody(), "fontSize", !0)),
                (r = /px$/.test(r) ? parseInt(r, 10) : 0),
                gb(a.split(" "), function (e) {
                    var t = hb.getStyle(d, e, !0);
                    if (
                        !(
                            ("background-color" === e && /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) && ((t = hb.getStyle(n.getBody(), e, !0)), "#ffffff" === hb.toHex(t).toLowerCase())) ||
                            ("color" === e && "#000000" === hb.toHex(t).toLowerCase())
                        )
                    ) {
            ...
            n.on("init", function () {
                ...
                n.on("keyup", function (e) {
                    ...
                    e.isDefaultPrevented() ||
                        ...
                        i.get() && r.typing && !1 === Nv(Cv(n), r.data[0]) && (!1 === n.isDirty() && (n.setDirty(!0), n.fire("change", { level: r.data[0], lastLevel: null })), n.fire("TypingUndo"), i.set(!1), n.nodeChanged()));
                }),
                n.on("keydown", function (e) {
                    ...
                    e.isDefaultPrevented() ||
                        ((33 <= n && n <= 36) || (37 <= n && n <= 40) || 45 === n
                            ? r.typing && a(e)
                            : ((t = (e.ctrlKey && !e.altKey) || e.metaKey), !(n < 16 || 20 < n) || 224 === n || 91 === n || r.typing || t || (r.beforeChange(), kv(r, !0, o), r.add({}, e), i.set(!0))));
                }),
            ...
            var e,
                ...
                l = function (e, t) {
                    ...
                    !(function (e) {
                        ...
                        ((n = a.getBody()),
                        (r =
                            !(Eb((o = e)) && !(kb(o) || ("keyup" === o.type && 229 === o.keyCode))) &&
                            (function (e, t, n) {
                        ...
                        (("" !== u.getAttrib(n, Nb)) === r && !t) ||
                            (u.setAttrib(n, Nb, r ? c : null), u.setAttrib(n, "aria-placeholder", r ? c : null), (i = r), a.fire("PlaceholderToggle", { state: i }), a.on(r ? "keydown" : "keyup", l), a.off(r ? "keyup" : "keydown", l)));
                };
            c &&
        ...
        Db = function (e, t, n) {
            var r,
                o,
                i,
                a = ((r = e), (o = t), (i = n), H(xu.DOM.getParents(i.container(), "*", o), r));
        ...
        Ob = function (e, t) {
            ...
            return e
                ? bo(n)
                    ...
                    : t
                : bo(n)
                ? Mn(n.previousSibling)
                    ? Is(n.previousSibling, n.previousSibling.data.length)
                    : Is.before(n)
                : So(t)
                ? Is(n, r - 1)
                : t;
        ...
        Fb = function (e, t) {
            var n = Rt.fromDom(e),
                r = Rt.fromDom(t.container());
            return Lb(n, r).map(function (e) {
                return { block: e, position: t };
            });
        },
        Ub = function (o, i, e) {
            var t = Fb(o, Is.fromRangeStart(e)),
                n = t.bind(function (e) {
                    return Rl(i, o, e.position).bind(function (e) {
                        return Fb(o, e).map(function (e) {
                            return (
                                (t = o),
                                (n = i),
                                jn((r = e).position.getNode()) && !1 === Wo(r.block)
                                    ? Ol(!1, r.block.dom)
                                          .bind(function (e) {
                                              return e.isEqual(r.position)
                                                  ? Rl(n, t, e).bind(function (e) {
                                                        return Fb(t, e);
                                                    })
                                                  : U.some(r);
                                          })
            ...
            return as(t, n, Mb).filter(function (e) {
                return (
                    !1 === Bt((r = e).from.block, r.to.block) &&
                    Wt((n = e).from.block)
                        .bind(function (t) {
        ...
        Xb = function (t, n) {
            var e,
                r,
                o,
                i = Rt.fromDom(t.getBody()),
                a =
                    ((e = i.dom),
                    (r = n),
                    ((o = t.selection.getRng()).collapsed ? Ub(e, r, o) : U.none()).bind(function (e) {
        ...
        Gb = function (e, t) {
            var n,
                r,
                o = Pl(e.dom, Is.fromRangeStart(t)).isNone(),
                i = Bl(e.dom, Is.fromRangeEnd(t)).isNone();
        ...
        Jb = function (e) {
            ...
            return Gb(i, a)
                ...
                : ((n = i),
                  (r = e.selection),
                  (o = r.getRng()),
                  as(Lb(n, Rt.fromDom(o.startContainer)), Lb(n, Rt.fromDom(o.endContainer)), function (e, t) {
                      return (
                          !1 === Bt(e, t) &&
                          (o.deleteContents(),
                          Kb(n, !0, e, t).each(function (e) {
                              r.setRng(e.toRange());
                          }),
                          !0)
                      );
        ...
        uC = function (n, r, e, t, o, i) {
            var a, u;
            return (
                tC(t, n, i.getNode(!o), o, !0).each(function (e) {
                    var t;
                ...
                (a = n.dom),
                Mn((u = e)) && 0 === u.data.length && a.remove(u),
                !0
            );
        },
        sC = function (e, t) {
        ...
        lC = function (e, t, n, r) {
            var o = r.getNode(!1 === t);
            return Lb(Rt.fromDom(e), Rt.fromDom(n.getNode()))
                .map(function (e) {
        ...
        fC = function (u, s, c) {
            return Rl(s, u, c).bind(function (e) {
                return (
                    (a = e.getNode()),
                    so(Rt.fromDom(a)) || ao(Rt.fromDom(a))
                        ? U.none()
                        : ((t = u),
                          (o = e),
                          (i = function (e) {
                          ...
                          il(!(n = s), (r = c)).fold(function () {
                              ...
                              ? U.none()
                              : (s && qn(e.getNode())) || (!1 === s && qn(e.getNode(!0)))
                              ? lC(u, s, c, e)
                              : (s && ip(c)) || (!1 === s && op(c))
                              ? U.some(cC.moveToPosition(e))
                              : U.none())
                );
                var t, n, r, o, i, a;
            });
        ...
        dC = function (r, e, o) {
            return (
                ...
                (a = o.getNode(!1 === i)),
                (u = i ? "after" : "before"),
                Rn(a) && a.getAttribute("data-mce-caret") === u
                    ? ((t = e),
                      (n = o.getNode(!1 === e)),
                      (t && qn(n.nextSibling) ? U.some(cC.moveToElement(n.nextSibling)) : !1 === t && qn(n.previousSibling) ? U.some(cC.moveToElement(n.previousSibling)) : U.none()).fold(function () {
                          return fC(r, e, o);
                      }, U.some))
                    : fC(r, e, o).bind(function (e) {
                          return (
                              (t = r),
                              (n = o),
                              e.fold(
            ...
            return mC(a, e)
                ...
                .fold(function () {
                    return (
                        ...
                        (i = Rt.fromDom(e)),
                        (!1 === t && ip(o)
                            ? U.some(cC.remove(o.getNode(!0)))
                            : t && op(o)
                            ? U.some(cC.remove(o.getNode()))
                            : !1 === t && op(o) && Sp(i, o)
                            ? Np(i, o).map(function (e) {
                                  return cC.remove(e.getNode());
                              })
                            : t && ip(o) && xp(i, o)
                            ? Ep(i, o).map(function (e) {
                                  return cC.remove(e.getNode());
                              })
                            : dC(e, t, o)
                        ).exists(function (e) {
        ...
        yC = function (e, t) {
            return (
                ...
                ((n = e),
                (r = t),
                (o = Is.fromRangeStart(n.selection.getRng())),
                Rl(r, n.getBody(), o)
                    .filter(function (e) {
                        return (r ? Qm : Zm)(e);
                    })
        ...
        YC = function (e, t) {
            var n = t.selection.getRng(),
                r = e ? Is.fromRangeEnd(n) : Is.fromRangeStart(n);
        ...
        ew = function (e, t, n) {
            return (
                ...
                (i = n),
                (a = (r = e).getBody()),
                (u = Is.fromRangeStart(r.selection.getRng())),
                (s = N(Rb, r)),
                KC(i, s, a, u)
                    .bind(function (e) {
                        return QC(r, o, e);
            ...
            return (
                d.on("NodeChange", function (e) {
                    ...
                    !wc(d) ||
                        ...
                        (u = d.dom),
                        (s = e.parents),
                        (c = z(qu(Rt.fromDom(u.getRoot()), '*[data-mce-selected="inline-boundary"]'), function (e) {
                            return e.dom;
                        })),
                        (l = H(c, a)),
                        (f = H(s, a)),
        ...
        aw = function (r, o, i, a) {
            ...
            r.undoManager.ignore(function () {
                ...
                r.selection.setRng(((e = i), (t = a), (n = document.createRange()).setStart(e.container(), e.offset()), n.setEnd(t.container(), t.offset()), n)),
                    ...
                    UC(s, u, Is.fromRangeStart(r.selection.getRng())).map(VC).map(iw(r, o));
            }),
                r.nodeChanged();
        },
        uw = function (n, r, i, o) {
        ...
        fw = function (r, o) {
            var t,
                e = Rt.fromDom(r.getBody()),
                n = Rt.fromDom(r.selection.getStart()),
                s = H(
                    ((t = fp(n, e)),
                    G(t, to).fold(S(t), function (e) {
                        return t.slice(0, e);
                    })),
                    cw
                );
            return oe(s).exists(function (e) {
                var t,
                    ...
                    a,
                    u,
                    n = Is.fromRangeStart(r.selection.getRng());
                return (
                    (i = o),
                    (a = n),
                    (u = e.dom),
                    !(
                        !as(Ll(u), Il(u), function (e, t) {
                            var n = Ob(!0, e),
                                r = Ob(!1, t),
                                o = Ob(!1, a);
                            return i
                                ? Bl(u, o).exists(function (e) {
            ...
            e.queryCommandState("InsertUnorderedList") || e.queryCommandState("InsertOrderedList") || "" !== o || l.getParent(t.getNode(), l.isBlock) || n.apply("div"),
                Y(bw(e), function (e) {
                    ...
                    (t = l),
                        ...
                        (a = e.dom),
                        (s = hw(r, Rt.fromDom(a))),
                        "outdent" === n ? ((u = Math.max(0, gw(a.style[s]) - o)), t.setStyle(a, s, u ? u + i : "")) : ((u = gw(a.style[s]) + o + i), t.setStyle(a, s, u));
                });
        },
        ww = function (e, t) {
        ...
        _w = function (e) {
            ...
            if (s && Rn(s) && l) {
                ...
                if (
                    ...
                    (m = c),
                    (p = s),
                    !F(lp(Rt.fromDom(p), Rt.fromDom(m)), function (e) {
                        return kw(d, e.dom);
                    }))
                ) {
                    for (var d, m, p, g, h, v = i.getRng(), y = v.startContainer, b = v.startOffset, C = v.endContainer, w = v.endOffset, x = vm(e), s = c.firstChild; s; )
                        if (((g = u), Mn((h = s)) || (Rn(h) && !kw(g, h) && !Xl(h)))) {
                            if (
                                (function (e, t) {
                                    if (Mn(t)) {
        ...
        Rw = function (e, t) {
            var n,
                r =
                    ((n = e),
                    Pr(Rt.fromDom(n.getBody()), "*[data-mce-caret]").fold(S(null), function (e) {
                        return e.dom;
                    }));
    ...
    var Tw,
        ...
        Bw = function (e, t, n, r) {
            for (var o, i, a, u, s, c, l = Nl(n), f = r, d = []; f && ((s = l), (c = f), (o = t === Ms.Forwards ? s.next(c) : s.prev(c))); ) {
                if (jn(o.getNode(!1))) return t === Ms.Forwards ? { positions: Ow(t, d).concat([o]), breakType: Yy.Br, breakAt: U.some(o) } : { positions: Ow(t, d), breakType: Yy.Br, breakAt: U.some(o) };
                if (o.isVisible()) {
                    if (e(f, o)) {
        ...
        Mw = N(Bw, Is.isAbove, -1),
        Fw = N(Bw, Is.isBelow, 1),
        Uw = N(Pw, -1, Mw),
        zw = N(Pw, 1, Fw),
        jw = function (t) {
            var e = function (e) {
    ...
    var Vw = function (o, i, a, e, u, t) {
        ...
        ex = function (e, o) {
            return Ne(e, function (e, t) {
                var n = Math.min(Gw(e, o), Jw(e, o)),
                    r = Math.min(Gw(t, o), Jw(t, o));
        ...
        nx = function (e, t, n) {
            var r,
                o,
                i = Hw(H(ie(e.getElementsByTagName("*")), jc)),
                a = H(i, N(Zw, n));
            if ((u = ex(a, t))) {
                var u,
                    s = !Pn(u.node) && !Wn(u.node);
                if (
                    (u = ex(
                        (function (e, r, t) {
                            void 0 === t && (t = !0);
                    ...
                    return (o = t), { node: (r = u).node, before: Gw(r, o) < Jw(r, o) };
            }
            return null;
        },
        rx = function (e, t) {
        ...
        lx = function (e, t, n) {
            var r,
                o,
                i = Nl(e.getBody()),
                a = N(sl, 1 === t ? i.next : i.prev);
            if (n.collapsed && "" !== lc(e)) {
                var u,
                    s = e.dom.getParent(n.startContainer, "PRE");
                if (!s) return;
                a(Is.fromRangeStart(n)) ||
                    ((o = (r = e).dom.create(lc(r))), (!xt.ie || 11 <= xt.ie) && (o.innerHTML = '<br data-mce-bogus="1">'), (u = o), 1 === t ? e.$(s).after(u) : e.$(s).before(u), e.selection.select(u, !0), e.selection.collapse());
            }
        },
        fx = function (e, t) {
        ...
        wx = function (t, n) {
            var e,
                r,
                o = Rt.fromDom(t.getBody()),
                i = Is.fromRangeStart(t.selection.getRng()),
                a = lc(t),
                u = fc(t);
            return (
                (e = i),
                (r = N(Bt, o)),
                Dr(Rt.fromDom(e.container()), to, r)
                    .filter(hx)
                    .exists(function () {
                        if (Cx(o, n, i)) {
                            var e = bx(o, a, u, n);
        ...
        Tx = function (e, t, n, r, o) {
            var i,
                a,
                u = qu(Rt.fromDom(n), "td,th,caption").map(function (e) {
                    return e.dom;
                }),
        ...
        Lx = function (e, t, n) {
            var r,
                ...
                a,
                u = e(t, n);
            return ((a = u).breakType === Yy.Wrap && 0 === a.positions.length) || (!jn(n.getNode()) && (i = u).breakType === Yy.Br && 1 === i.positions.length)
                ? ((r = e),
                  (o = t),
        ...
        Fx = function (t, e, n, r) {
            ...
            return (
                !(
                    ...
                    (i = s),
                    (a = n),
                    (u = Is.fromRangeStart(i)),
                    !Ol(!o, a).exists(function (e) {
                        return e.isEqual(u);
                    }))
                ) &&
        ...
        $x = function (i, a) {
            i.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() &&
                    ...
                    Ex(
                        [
                            { keyCode: ed.RIGHT, action: Nx(mx, t, !0) },
                            { keyCode: ed.LEFT, action: Nx(mx, t, !1) },
                            { keyCode: ed.UP, action: Nx(px, t, !1) },
                            { keyCode: ed.DOWN, action: Nx(px, t, !0) },
                            { keyCode: ed.RIGHT, action: Nx(Vx, t, !0) },
                            { keyCode: ed.LEFT, action: Nx(Vx, t, !1) },
                            { keyCode: ed.UP, action: Nx(qx, t, !1) },
                            { keyCode: ed.DOWN, action: Nx(qx, t, !0) },
                            { keyCode: ed.RIGHT, action: Nx(kx, t, !0) },
                            { keyCode: ed.LEFT, action: Nx(kx, t, !1) },
                            { keyCode: ed.UP, action: Nx(_x, t, !1) },
                            { keyCode: ed.DOWN, action: Nx(_x, t, !0) },
                            { keyCode: ed.RIGHT, action: Nx(ew, t, n, !0) },
                            { keyCode: ed.LEFT, action: Nx(ew, t, n, !1) },
                            { keyCode: ed.RIGHT, ctrlKey: !o.isOSX(), altKey: o.isOSX(), action: Nx(rw, t, n) },
                            { keyCode: ed.LEFT, ctrlKey: !o.isOSX(), altKey: o.isOSX(), action: Nx(ow, t, n) },
                            { keyCode: ed.UP, action: Nx(xx, t, !1) },
                            { keyCode: ed.DOWN, action: Nx(xx, t, !0) },
                        ],
                        r
                    ).each(function (e) {
                        r.preventDefault();
        ...
        Wx = function (o, i) {
            o.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() &&
                    ...
                    Ex(
                        [
                            { keyCode: ed.BACKSPACE, action: Nx(ww, t, !1) },
                            { keyCode: ed.BACKSPACE, action: Nx(vC, t, !1) },
                            { keyCode: ed.DELETE, action: Nx(vC, t, !0) },
                            { keyCode: ed.BACKSPACE, action: Nx(sC, t, !1) },
                            { keyCode: ed.DELETE, action: Nx(sC, t, !0) },
                            { keyCode: ed.BACKSPACE, action: Nx(sw, t, n, !1) },
                            { keyCode: ed.DELETE, action: Nx(sw, t, n, !0) },
                            { keyCode: ed.BACKSPACE, action: Nx(_g, t, !1) },
                            { keyCode: ed.DELETE, action: Nx(_g, t, !0) },
                            { keyCode: ed.BACKSPACE, action: Nx(yC, t, !1) },
                            { keyCode: ed.DELETE, action: Nx(yC, t, !0) },
                            { keyCode: ed.BACKSPACE, action: Nx(pw, t, !1) },
                            { keyCode: ed.DELETE, action: Nx(pw, t, !0) },
                            { keyCode: ed.BACKSPACE, action: Nx(Qb, t, !1) },
                            { keyCode: ed.DELETE, action: Nx(Qb, t, !0) },
                            { keyCode: ed.BACKSPACE, action: Nx(Xb, t, !1) },
                            { keyCode: ed.DELETE, action: Nx(Xb, t, !0) },
                            { keyCode: ed.BACKSPACE, action: Nx(dw, t, !1) },
                            { keyCode: ed.DELETE, action: Nx(dw, t, !0) },
                        ],
                        r
                    ).each(function (e) {
                        r.preventDefault();
                ...
                o.on("keyup", function (e) {
                    ...
                    !1 === e.isDefaultPrevented() &&
                        ...
                        Ex(
                            [
                                { keyCode: ed.BACKSPACE, action: Nx(hC, t) },
                                { keyCode: ed.DELETE, action: Nx(hC, t) },
                            ],
                            n
                        ));
                });
            ...
            if (t) {
                !/^(LI|DT|DD)$/.test(t.nodeName) ||
                    ((r = (function (e) {
                        ...
                        t.insertBefore(i.doc.createTextNode(fo), t.firstChild));
                var u = i.createRng();
        ...
        Zx = function (e, t, n, r, o) {
            ...
            n !== e.getBody() &&
                (Gx((i = n)) && Gx(i.parentNode) && (o = "LI"),
                (a = o ? t(o) : p.create("BR")),
                Qx(n, r, !0) && Qx(n, r, !1)
                    ? Yx(n, "LI")
                        ? ((u = Jx(n)), p.insertAfter(a, u), (null === (m = (d = n).parentNode) || void 0 === m ? void 0 : m.firstChild) === d ? p.remove(u) : p.remove(n))
                        : p.replace(a, n)
                    : (Qx(n, r, !0)
                          ? Yx(n, "LI")
                              ? (p.insertAfter(a, Jx(n)), a.appendChild(p.doc.createTextNode(" ")), a.appendChild(n))
                              : n.parentNode.insertBefore(a, n)
                          : Qx(n, r, !1)
                          ? p.insertAfter(a, Jx(n))
                          : ((n = Jx(n)),
                            (s = g.cloneRange()).setStartAfter(r),
                            s.setEndAfter(n),
                            (c = s.extractContents()),
                            "LI" === o && ((f = "LI"), (l = c).firstChild && l.firstChild.nodeName === f) ? ((a = c.firstChild), p.insertAfter(c, n)) : (p.insertAfter(c, n), p.insertAfter(a, n))),
                      p.remove(r)),
                Kx(e, a));
        },
        eS = function (e) {
            ...
            E &&
                    ...
                    (u = (function (e, t, n, r, o) {
                        ...
                        if (!p || !nS(d, p)) {
                            if (((c = (p = p || m) === e.getBody() || ((l = p) && /^(TD|TH|CAPTION)$/.test(l.nodeName)) ? p.nodeName.toLowerCase() : p.parentNode.nodeName.toLowerCase()), !p.hasChildNodes()))
                                return (i = d.create(f)), iS(e, i), p.appendChild(i), n.setStart(i, 0), n.setEnd(i, 0), i;
                ...
                /^(LI|DT|DD)$/.test(c) && f.isEmpty(s)
                    ...
                    : (N && s === a.getBody()) ||
                      ((N = N || "P"),
                      yo(s)
                          ? ((n = _o(s)), f.isEmpty(s) && eS(s), iS(a, n), Kx(a, n))
                          : h()
                          ? v()
                          : h(!0)
                          ? ((n = s.parentNode.insertBefore(g(), s)), Kx(a, tS(s, "HR") ? n : s))
                          : ((S = (x = p).cloneRange()).setStart(x.startContainer, rS(!0, x.startContainer, x.startOffset)),
                            S.setEnd(x.endContainer, rS(!1, x.endContainer, x.endOffset)),
                            (t = S.cloneRange()).setEndAfter(s),
                            (r = t.extractContents()),
                            (w = r),
                            Y(Vu(Rt.fromDom(w), zt), function (e) {
                                var t = e.dom;
                            ...
                            f.isEmpty(s) && eS(s),
                            n.normalize(),
                            f.isEmpty(n) ? (f.remove(n), v()) : (iS(a, n), Kx(a, n))),
                      f.setAttrib(n, "id", ""),
        ...
        AS = function (e, t) {
            return RC(
                [
                    _S([yS], vS.none()),
                    _S([wS("summary", !0)], vS.br()),
                    _S([xS(!0), SS(!1), ES], vS.br()),
                    _S([xS(!0), SS(!1)], vS.block()),
                    _S([xS(!0), SS(!0), ES], vS.block()),
                    _S([xS(!0), SS(!0)], vS.br()),
                    _S([CS(!0), ES], vS.br()),
                    _S([CS(!0)], vS.block()),
                    _S([bS(!0), ES, kS], vS.block()),
                    _S([bS(!0)], vS.br()),
                    _S([NS], vS.br()),
                    _S([bS(!1), ES], vS.br()),
                    _S([kS], vS.block()),
        ...
        DS = function (r) {
            r.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() &&
                    ...
                    Ex(
                        [
                            { keyCode: ed.END, action: Nx(gx, t, !0) },
                            { keyCode: ed.HOME, action: Nx(gx, t, !1) },
                            { keyCode: ed.END, action: Nx(Ax, t, !0) },
                            { keyCode: ed.HOME, action: Nx(Ax, t, !1) },
                        ],
                        n
                    ).each(function (e) {
                        n.preventDefault();
        ...
        FS = function (e) {
            var t,
                n,
                r = Is.fromRangeStart(e.selection.getRng()),
                o = Rt.fromDom(e.getBody());
            if (e.selection.isCollapsed()) {
                var i = N(Rb, e),
                    a = Is.fromRangeStart(e.selection.getRng());
                return UC(i, e.getBody(), a)
                    .bind(
                        ((n = o),
                        function (e) {
                            return e.fold(
        ...
        US = function (r) {
            r.on("keydown", function (e) {
                ...
                !1 === e.isDefaultPrevented() &&
                    ((t = r),
                    (n = e),
                    Ex([{ keyCode: ed.SPACEBAR, action: Nx(FS, t) }], n).each(function (e) {
                        n.preventDefault();
                    }));
            });
        },
        ...
        jS =
            ((HS.prototype.nodeChanged = function (e) {
                var t,
                    n,
                    r,
            ...
            r.on("mouseup", function (e) {
                !e.isDefaultPrevented() &&
                    ...
                    ("IMG" === r.selection.getNode().nodeName
                        ? Wr.setEditorTimeout(r, function () {
                              r.nodeChanged();
                          })
                        : r.nodeChanged());
            });
    ...
    var VS = function (e) {
        ...
        KS = function (e, t) {
            return (
                (n = (u = e).inline ? WS(u.getBody()) : { left: 0, top: 0 }),
                (a = (i = e).getBody()),
                    ...
                    pageX:
                        (o = (function (e, t) {
                            ...
                            var n,
                                ...
                                i,
                                a,
                                u = WS(e.getContentAreaContainer()),
                                s =
                                    ((r = (n = e).getBody()),
            ...
            return (
                ...
                function (g) {
                    return e.on(function (e) {
                        ...
                        e.dragging &&
                            ((d = e),
                            (t = { pageX: (m = KS(h, g)).pageX - d.relX, pageY: m.pageY + 5 }),
                            (l = e.ghost),
                            (f = h.getBody()),
            ...
            var s,
                ...
                C = function (e) {
                    ...
                    var r = (function (e, t, n) {
                            var r = u.$,
                                o = Pr(Rt.fromDom(u.getBody()), "#" + p).fold(
                                    function () {
                                        return r([]);
                                    },
                                    function (e) {
                            ...
                            t === n && xt.ie
                                ...
                                : (o.empty().append(fo).append(t).append(fo), i.setStart(o[0].firstChild, 1), i.setEnd(o[0].lastChild, 0)),
                        ...
                        o = Rt.fromDom(e);
                    return (
                        Y(qu(Rt.fromDom(u.getBody()), "*[data-mce-selected]"), function (e) {
                            Bt(o, e) || Zn(e, i);
                        }),
                        ...
                        u.on(
                            ...
                            u.on("mousedown", function (e) {
                                ...
                                (o !== d && "HTML" !== o.nodeName && !l.isChildOf(o, d)) ||
                                    !1 === qy(u, e.clientX, e.clientY) ||
                                    ((t = iN(u, o))
                                        ? oN(t)
                                            ? (e.preventDefault(), nC(u, t).each(w))
                                            : (x(), (rN(t) && e.shiftKey) || Qf(e.clientX, e.clientY, c.getRng()) || (S(), c.placeCaretAt(e.clientX, e.clientY)))
                                        : g(o)
                                        ? nC(u, o).each(w)
                                        : !1 === jc(o) && (x(), S(), (n = nx(d, e.clientX, e.clientY)) && (i(o, n.node) || (e.preventDefault(), (r = v(1, n.node, n.before, !1)), u.getBody().focus(), h(r)))));
                            }),
                    ...
                    Range.prototype.getClientRects ||
                        u.on("mousedown", function (e) {
                            ...
                            h(e) ||
                                ...
                                ((t = u.getBody()).blur(),
                                Wr.setEditorTimeout(u, function () {
                                    t.focus();
                                }));
                        }),
                    (n = function () {
        ...
        fN = function (u) {
            var e = u.dom.getRoot();
            u.inline ||
                (zf(u) && u.selection.getStart(!0) !== e) ||
                Ll(e).each(function (e) {
                    var t,
                        n,
                        r,
                        o,
                        i = e.getNode(),
                        a = Pn(i) ? Ll(i).getOr(e) : e;
        ...
        gN = function (t, e) {
            ...
            var i,
                ...
                c,
                l,
                f = t.getParam("directionality", Ou.isRtl() ? "rtl" : undefined);
            f !== undefined && (o.dir = f),
                n.protect &&
                ...
                0 < t.contentStyles.length &&
                    ((i = ""),
                    _t.each(t.contentStyles, function (e) {
                        i += e + "\r\n";
                    }),
                    t.dom.addStyle(i)),
                pN(t, t.contentCSS),
        ...
        hN = function (t, e) {
            ...
            n.inline || (t.getElement().style.visibility = t.orgVisibility),
                ...
                t.inline && (sN.addClass(r, "mce-content-body"), (t.contentDocument = o = document), (t.contentWindow = window), (t.bodyElement = r), (t.contentAreaContainer = r));
            var u,
                i,
                a,
                s,
            ...
            (c.disabled = !0),
                ...
                t.readonly || (t.inline && "static" === sN.getStyle(c, "position", !0) && (c.style.position = "relative"), (c.contentEditable = t.getParam("content_editable_state", !0))),
                (c.disabled = !1),
                (t.editorUpload = mb(t)),
                (t.schema = Ci(n)),
                (t.dom = xu(o, {
                ...
                (t.parser =
                    ((i = uy(lN((u = t)), u.schema)).addAttributeFilter("src,href,style,tabindex", function (e, t) {
                ...
                (t.selection = Hv(t.dom, t.getWin(), t.serializer, t)),
                (t.annotator = Yf(t)),
                (t.formatter = Cb(t)),
                (t.undoManager = xb(t)),
                (t._nodeChangeDispatcher = new jS(t)),
                (t._selectionOverrides = aN(t)),
                Ew(t),
                VS(t),
                Rv(t) || $S(t);
            var l,
                f,
                d = Rv((l = t)) ? Au(null) : zS(l);
            Sw(t, d),
                lc((f = t)) && f.on("NodeChange", N(_w, f)),
                _b(t),
                t.fire("PreInit"),
                Tv(t).fold(
                    function () {
        ...
        bN = function (e, t) {
            var n,
                ...
                u =
                    ...
                    (i = Rt.fromTag("iframe")),
                    Gn(i, o),
                    Gn(i, { id: n + "_ifr", frameBorder: "0", allowTransparency: "true", title: r }),
        ...
        wN = function (t, n, e) {
            var r = Ky.get(e),
                o = Ky.urls[e] || t.documentBaseUrl.replace(/\/$/, "");
            if (((e = _t.trim(e)), r && -1 === _t.inArray(n, e))) {
                if (
                    (_t.each(Ky.dependencies(e), function (e) {
                        wN(t, n, e);
                    }),
                    t.plugins[e])
                )
        ...
        kN = function (e) {
            ...
            e.fire("ScriptsLoaded"),
                ...
                (o = _e(_e({}, My.get("default").icons), My.get(t).icons)),
                se(o, function (e, t) {
                    ve(r, t) || n.ui.registry.addIcon(t, e);
                }),
                (u = Cc((i = e))),
                K(u) ? ((i.settings.theme = xN(u)), (a = Xy.get(u)), (i.theme = new a(i, Xy.urls[u])), i.theme.init && i.theme.init(i, Xy.urls[u] || i.documentBaseUrl.replace(/\/$/, ""), i.$)) : (i.theme = {}),
                (s = e),
                (c = []),
                _t.each(xc(s).split(/[ ,]/), function (e) {
                    wN(s, c, xN(e));
                });
            var l,
                f,
            ...
            var p,
                g,
                h,
                v = { editorContainer: m.editorContainer, iframeContainer: m.iframeContainer };
            return (
                (e.editorContainer = v.editorContainer ? v.editorContainer : null),
                ab(e),
                e.inline
                    ? hN(e)
                    : ((h = bN((p = e), (g = v))),
                      g.editorContainer && ((vN.get(g.editorContainer).style.display = p.orgDisplay), (p.hidden = vN.isHidden(g.editorContainer))),
                      (p.getElement().style.display = "none"),
                      vN.setAttrib(p.id, "aria-hidden", "true"),
                      void (h || hN(p)))
            );
        },
        _N = xu.DOM,
            ...
            (n = s),
                ...
                (i = function () {
                    ...
                    RN(s, e),
                        ...
                        (r = e),
                        (o = t),
                        _t.each(r.getParam("external_plugins"), function (e, t) {
                ...
                (u = Cc((r = e))),
                K(u)
                    ? (AN(u) || Xy.urls.hasOwnProperty(u) || ((a = r.getParam("theme_url")) ? Xy.load(u, r.documentBaseURI.toAbsolute(a)) : Xy.load(u, "themes/" + u + "/theme" + o + ".js")),
        ...
        BN = function (t) {
            ...
            Ti.Event.domLoaded
                ? t.getElement() &&
                  ...
                  (t.ui.styleSheetLoader = ((o = n), (i = t), Xr.forElement(o, { contentCssCors: i.getParam("content_css_cors"), referrerPolicy: pc(i) }))),
                  t.getParam("inline") ? (t.inline = !0) : ((t.orgVisibility = t.getElement().style.visibility), (t.getElement().style.visibility = "hidden")),
                  (a = t.getElement().form || _N.getParent(e, "form")) &&
                      ((t.formElement = a),
                      t.getParam("hidden_input") && !In(t.getElement()) && (_N.insertAfter(_N.create("input", { type: "hidden", name: e }), e), (t.hasHiddenInput = !0)),
                      (t.formEventDelegate = function (e) {
                          t.fire(e.type, e);
                      }),
                      _N.bind(a, "submit reset", t.formEventDelegate),
                      t.on("reset", function () {
                          t.resetContent();
                      }),
                  ...
                  (t.windowManager = Jy(t)),
                  (t.notificationManager = Wy(t)),
                  ...
                  ON(t, t.suffix))
                : _N.bind(window, "ready", u);
        },
        PN = function (e, t) {
            return (n = t), Ov(e).editor.addVisual(n);
            var n;
        },
        LN = { "font-size": "size", "font-family": "face" },
        IN = function (n, t, e) {
            return Xg(
                Rt.fromDom(e),
                function (e) {
        ...
        qN = function (e, t) {
            var n,
                ...
                o,
                i,
                a = "string" != typeof (n = t) ? ((r = _t.extend({ paste: n.paste, data: { paste: n.paste } }, n)), { content: n.content, details: r }) : { content: n, details: {} };
        ...
        KN = _t.inArray,
        XN =
            ((YN.prototype.execCommand = function (t, n, r, e) {
                var o,
                    i,
                    a = !1,
                    u = this;
                if (!u.editor.removed) {
                    ...
                    if (
                        ($N(this.editor.plugins, function (e) {
            ...
            (YN.prototype.setupCommands = function (i) {
                ...
                this.addCommands({
                    ...
                    "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull,JustifyNone": function (e) {
                        var t = e.substring(7);
                        "full" === t && (t = "justify"),
                            $N("left,center,right,justify".split(","), function (e) {
                    ...
                    selectAll: function () {
                        var e,
                            t = i.dom.getParent(i.selection.getStart(), Vn);
                        ...
                        function () {
                            return jN((t = i), function (n) {
                                ...
                                return Xg(
                                    ...
                                    var e = parseFloat(tr(n, "line-height")),
                                        t = parseFloat(tr(n, "font-size"));
                                    return String(e / t);
                                });
                            }).getOr("");
                            var t;
    ...
    var GN = "data-mce-contenteditable",
        JN = function (e, t, n) {
            var r, o;
            ...
            JN(i, "mce-content-readonly", t),
                t
                    ? (e.selection.controlSelection.hideResizeRect(),
                      ...
                      (e.readonly = !0),
                      ZN(i, !1),
                      Y(qu(i, '*[contenteditable="true"]'), function (e) {
                          Yn(e, GN, "true"), ZN(e, !1);
                      }))
                    : ((e.readonly = !1),
                      ZN(i, !0),
                      Y(qu(i, "*[" + GN + '="true"]'), function (e) {
                          Zn(e, GN), ZN(e, !0);
                      }),
                      QN(e, "StyleWithCSS", !1),
                      QN(e, "enableInlineTableEditing", !1),
                      QN(e, "enableObjectResizing", !1),
                      (vm((r = e)) || hm(r)) && e.focus(),
            ...
            "click" !== u.type ||
                ...
                Lr(e, "a", function (e) {
                    ...
                    .each(function (e) {
                        ...
                        u.preventDefault(),
                            /^#/.test(e)
                                ? (t = a.dom.select(e + ',[name="' + (qe((n = e), (r = "#")) ? ((o = n), (i = r.length), o.substring(i)) : n) + '"]')).length && a.selection.scrollIntoView(t[0], !0)
    ...
    var uE,
        ...
        pE = _e(_e({}, cE), {
            ...
            toggleNativeEvent: function (e, t) {
                ...
                "focus" !== e &&
                    "blur" !== e &&
                    (t ? (n.initialized ? mE(n, e) : n._pendingNativeEvents ? n._pendingNativeEvents.push(e) : (n._pendingNativeEvents = [e])) : n.initialized && (n.dom.unbind(fE(n, e), e, n.delegates[e]), delete n.delegates[e]));
            },
        ...
        vE = function (t) {
            var e,
                n,
                r = Au("design"),
                o = Au({ design: { activate: te, deactivate: te, editorReadOnly: !1 }, readonly: { activate: te, deactivate: te, editorReadOnly: !0 } });
            return (
                (e = t).serializer
                    ? nE(e)
        ...
        yE = _t.each,
        bE = _t.explode,
        CE = { f1: 112, f2: 113, f3: 114, f4: 115, f5: 116, f6: 117, f7: 118, f8: 119, f9: 120, f10: 121, f11: 122, f12: 123 },
        wE = _t.makeMap("alt,ctrl,shift,meta,access"),
        xE = function (e) {
            var t,
                n = {};
        ...
        SE =
            ((NE.prototype.add = function (e, n, t, r) {
                var o = this,
                    i = o.normalizeCommandFunc(t);
                return (
                    yE(bE(_t.trim(e)), function (e) {
            ...
            (NE.prototype.createShortcut = function (e, t, n, r) {
                ...
                return (o[o.length - 1] = _t.extend(o[o.length - 1], { func: n, scope: r || this.editor })), _t.extend(o[0], { desc: this.editor.translate(t), subpatterns: o.slice(1) });
            }),
    ...
    var EE = function () {
        ...
        RE = { ftp: 21, http: 80, https: 443, mailto: 25 },
        TE =
            ((DE.parseDataUri = function (e) {
                var t,
                    n = decodeURIComponent(e).split(","),
                    r = /data:([^;]+)/.exec(n[0]);
                return r && (t = r[1]), { type: t, data: n[1] };
    ...
    function DE(e, t) {
        ...
        /^([\w\-]+):([^\/]{2})/i.test(e) || /^\s*#/.test(e)
            ...
            : ((n = 0 === e.indexOf("//")),
              ...
              /^[\w\-]*:?\/\//.test(e) ||
                  ((r = this.settings.base_uri ? this.settings.base_uri.path : new DE(document.location.href).directory),
        ...
        ME =
            ...
            (FE.prototype.execCallback = function (e) {
                ...
                if (o)
                    return (
                        ...
                        "string" == typeof o && ((r = (r = o.replace(/\.\w+$/, "")) ? LE(r) : 0), (o = LE(o)), (this.callbackLookup = this.callbackLookup || {}), (this.callbackLookup[e] = { func: o, scope: r })),
                        o.apply(r || this, t)
                    );
            }),
            ...
            (FE.prototype.hide = function () {
                var e = this,
                    t = e.getDoc();
                e.hidden ||
                    (IE && t && !e.inline && t.execCommand("SelectAll"),
                    e.save(),
                    e.inline ? ((e.getBody().contentEditable = "false"), e === e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (OE.hide(e.getContainer()), OE.setStyle(e.id, "display", e.orgDisplay)),
                    (e.hidden = !0),
                    e.fire("hide"));
            }),
            ...
            (FE.prototype.load = function (e) {
                ...
                if (t) {
                    (e = e || {}).load = !0;
                    var n = In(t) ? t.value : t.innerHTML,
    ...
    function FE(e, t, n) {
        ...
        (this.plugins = {}),
            ...
            BE(this, pE),
            (this.settings = Py(this, e, this.documentBaseUrl, n.defaultSettings, t)),
            ...
            this.settings.referrer_policy && (ku.ScriptLoader._setReferrerPolicy(this.settings.referrer_policy), xu.DOM.styleSheetLoader._setReferrerPolicy(this.settings.referrer_policy)),
            (Bu.languageLoad = this.settings.language_load),
            (Bu.baseURL = n.baseURL),
            (this.id = e),
            this.setDirty(!1),
            (this.documentBaseURI = new TE(this.settings.document_base_url, { base_uri: this.baseUri })),
            ...
            (this.ui = { registry: EE(), styleSheetLoader: undefined, show: te, hide: te, enable: te, disable: te, isDisabled: b });
        var o = vE(this);
        (this.mode = o),
            (this.setMode = o.set),
            n.fire("SetupEditor", { editor: this }),
            this.execCallback("setup", this),
            (this.$ = gu.overrideDefaults(function () {
    ...
    var UE,
        ...
        GE = function (t) {
            ...
            return (
                ...
                QE.activeEditor === t && (QE.activeEditor = 0 < KE.length ? KE[0] : null),
                QE.focusedEditor === t && (QE.focusedEditor = null),
                e.length !== KE.length
            );
        },
        JE = "CSS1Compat" !== document.compatMode,
        QE = _e(_e({}, cE), {
            baseURI: null,
            baseURL: null,
            defaultSettings: {},
            ...
            setup: function () {
                var e,
                    t = "",
                    n = TE.getDocumentBaseUrl(document.location);
                            ...
                            (o = gu.unique(
                                (function (t) {
                                    ...
                                    if (xt.browser.isIE() && xt.browser.version.major < 11)
                                        return rb("TinyMCE does not support the browser you are using. For a list of supported browsers please see: https://www.tinymce.com/docs/get-started/system-requirements/"), [];
            ...
            add: function (e) {
                ...
                return (
                    WE[e.id] === e ||
                        (null === n.get(e.id) && ("length" !== e.id && (WE[e.id] = e), WE.push(e), KE.push(e)),
                        YE(!0),
                        (n.activeEditor = e),
                        ...
                        UE ||
                            ...
                            window.addEventListener("beforeunload", UE))),
                    e
                );
            },
    ...
    var ZE,
        ...
        sk = {
            ...
            intersect: function (e, t) {
                var n = ok(e.x, t.x),
                    r = ok(e.y, t.y),
                    o = rk(e.x + e.w, t.x + t.w),
                    i = rk(e.y + e.h, t.y + t.h);
    ...
    dk.extend = tk = function (n) {
        ...
        return (
            (nk = !1),
            n.Mixins &&
                (lk(n.Mixins, function (e) {
                    for (var t in e) "init" !== t && (n[t] = e[t]);
                }),
                o.Mixins && (n.Mixins = o.Mixins.concat(n.Mixins))),
            n.Methods &&
                lk(n.Methods.split(","), function (e) {
                    n[e] = t;
                }),
            n.Properties &&
                lk(n.Properties.split(","), function (e) {
                    var t = "_" + e;
                    n[e] = function (e) {
            ...
            n.Statics &&
                lk(n.Statics, function (e, t) {
                    r[t] = e;
                }),
            n.Defaults && o.Defaults && (n.Defaults = fk({}, o.Defaults, n.Defaults)),
            se(n, function (e, t) {
                var n, r;
        ...
        yk = _e(_e({}, cE), {
            send: function (e) {
                ...
                if (
                    ...
                    (e.async = !1 !== e.async),
                    (e.data = e.data || ""),
                    yk.fire("beforeInitialize", { settings: e }),
                    ...
                    e.requestheaders &&
                        _t.each(e.requestheaders, function (e) {
                            t.setRequestHeader(e.key, e.value);
                        }),
                    t.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
                    (t = yk.fire("beforeSend", { xhr: t, settings: e }).xhr).send(e.data),
                    !e.async)
                )
                    return r();
                Wr.setTimeout(r, 10);
        ...
        Ck =
            ...
            (wk.prototype.send = function (e) {
                ...
                (o.success = function (e, t) {
                    ...
                    (o.data = hk.serialize({ id: e.id || "c" + this.count++, method: e.method, params: e.params })),
    ...
    var Nk,
        Ek = {
                    ...
                    return (
                        ...
                        (n.toHsv = function () {
                            return (
                                ...
                                (n = c),
                                (o = 0),
                                (i = mk((e /= 255), mk((t /= 255), (n /= 255)))),
                                (a = pk(e, pk(t, n))),
                                i === a
                                    ? { h: 0, s: 0, v: 100 * (o = i) }
                                    : ((r = (a - i) / a), { h: gk(60 * ((e === i ? 3 : n === i ? 1 : 5) - (e === i ? t - n : n === i ? e - t : n - e) / ((o = a) - i))), s: gk(100 * r), v: gk(100 * o) })
                            );
                            var e, t, n, r, o, i, a;
                        }),
                        (n.toHex = function () {
            ...
            html: { Styles: xi, Entities: li, Node: Am, Schema: Ci, SaxParser: Pm, DomParser: uy, Writer: Vm, Serializer: qm },
            Env: xt,
            AddOnManager: Bu,
            Annotator: Yf,
            Formatter: Cb,
        ...
        (c =
            void 0 === u
                ...
                : ((n = t(r, u)).sendStat("script_load")(),
                  {
                      load: function (t) {
                          t.once("init", n.sendStat("init")),
                              t.once("focus", n.sendStat("focus")),
                              t.on("ExportPdf", n.sendStat("export_pdf")),
