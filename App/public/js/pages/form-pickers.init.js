!(function (t) {
    ...
    (e.prototype.init = function () {
        t("#basic-datepicker").flatpickr(),
            t("#datetime-datepicker").flatpickr({ enableTime: !0, dateFormat: "Y-m-d H:i" }),
            t("#humanfd-datepicker").flatpickr({ altInput: !0, altFormat: "F j, Y", dateFormat: "Y-m-d" }),
            t("#minmax-datepicker").flatpickr({ minDate: "2020-01", maxDate: "2020-03" }),
            ...
            t("#conjunction-datepicker").flatpickr({ mode: "multiple", dateFormat: "Y-m-d", conjunction: " :: " }),
            t("#range-datepicker").flatpickr({ mode: "range" }),
            t("#inline-datepicker").flatpickr({ inline: !0 }),
            t("#basic-timepicker").flatpickr({ enableTime: !0, noCalendar: !0, dateFormat: "H:i" }),
            ...
            t("#colorpicker-showintial").spectrum({ showInitial: !0 }),
            t("#colorpicker-showinput-intial").spectrum({ showInitial: !0, showInput: !0 }),
            t(".clockpicker").clockpicker({ donetext: "Done" }),
            t("#single-input").clockpicker({ placement: "bottom", align: "left", autoclose: !0, default: "now" }),
