document.getElementById("sa-basic").addEventListener("click", function () {
    ...
    document.getElementById("sa-image").addEventListener("click", function () {
        Swal.fire({ title: "Adminto", text: "Responsive Bootstrap 5 Admin Dashboard", imageUrl: "../assets/images/logo-sm.png", imageHeight: 50, confirmButtonColor: "#4a4fea", animation: !1 });
    }),
