jQuery(document).ready(function (i) {
    ...
    (s.showOverlay = function () {
        ...
        i("#main .message-list li").on("click", function (t) {
          let idMessaggio = t.target.attributes.idmessaggio.value;
          i.post("/Messaggi/GetMessaggio", {idMessaggio:idMessaggio}).done((risp) => {
            if(risp.status == 'ok'){
              i('#dataMessaggio').html(risp.dataMessaggio);
              i('#OggettoMessaggio').html(risp.oggetto);
              i('#dettagliMessaggio').html(risp.messaggio);
            }else{
              return false;
            }
        ...
        i(".nano").nanoScroller(),
        i(".search-box input").on("focus", function () {
            i(window).width() <= 1360 && s.hideMessage();
        })
        //i(".summernote").summernote({ height: 280, minHeight: null, maxHeight: null, focus: !1 });
      }),
    (function (s, o, n) {
        "use strict";
        ...
        (y = {
            ...
            (h = "down"),
            (f = "touchmove"),
            (c = "Microsoft Internet Explorer" === o.navigator.appName && /msie 7./i.test(o.navigator.appVersion) && o.ActiveXObject),
            (p = null),
            (x = o.requestAnimationFrame),
            (m = o.cancelAnimationFrame),
            (C = n.createElement("div").style),
            (H = (function () {
                var t, e, i, s;
                for (t = i = 0, s = (e = ["t", "webkitT", "MozT", "msT", "OT"]).length; i < s; t = ++i) if ((e[t], e[t] + "ransform" in C)) return e[t].substr(0, e[t].length - 1);
                return !1;
            })()),
            ($ = (function (t) {
            ...
            (r = (function () {
                function t(t, e) {
                    (this.el = t),
                        ...
                        p || (p = b()),
                        (this.$el = s(this.el)),
                        (this.doc = s(this.options.documentContext || n)),
                ...
                return (
                    ...
                    (t.prototype.setOnScrollStyles = function () {
                        var t, e;
                        w ? ((t = {})[$] = "translate(0, " + this.sliderTop + "px)") : (t = { top: this.sliderTop }),
                            x
                                ? this.scrollRAF ||
                                  (this.scrollRAF = x(
                                      ((e = this),
                    ...
                    (t.prototype.createEvents = function () {
                        ...
                        this.events = {
                            ...
                            drag:
                                ...
                                function (t) {
                                    return (
                                        ...
                                        l.scroll(),
                                        l.contentScrollTop >= l.maxScrollTop && l.prevScrollTop !== l.maxScrollTop ? l.$el.trigger("scrollend") : 0 === l.contentScrollTop && 0 !== l.prevScrollTop && l.$el.trigger("scrolltop"),
                                        !1
                                    );
                                }),
                            up:
                            ...
                            panedown:
                                ((s = this),
                                function (t) {
                                    return (s.sliderY = (t.offsetY || t.originalEvent.layerY) - 0.5 * s.sliderHeight), s.scroll(), s.events.down(t), !1;
                                }),
                            scroll:
                                ((e = this),
                                function (t) {
                                        ...
                                        e.isBeingDragged ||
                                            ...
                                            null != t &&
                                                (e.contentScrollTop >= e.maxScrollTop
                                                    ? (e.options.preventPageScrolling && e.preventScrolling(t, h), e.prevScrollTop !== e.maxScrollTop && e.$el.trigger("scrollend"))
                                                    : 0 === e.contentScrollTop && (e.options.preventPageScrolling && e.preventScrolling(t, S), 0 !== e.prevScrollTop && e.$el.trigger("scrolltop"))));
                                }),
                            wheel:
                                ((i = this),
                                function (t) {
                                    var e;
                                    if (null != t)
                                        return (e = t.delta || t.wheelDelta || (t.originalEvent && t.originalEvent.wheelDelta) || -t.detail || (t.originalEvent && -t.originalEvent.detail)) && (i.sliderY += -e / 3), i.scroll(), !1;
                                }),
                        };
                    }),
                    (t.prototype.addEvents = function () {
                        ...
                        this.removeEvents(),
                            ...
                            this.iOSNativeScrolling || (this.slider.bind(e, t[h]), this.pane.bind(e, t.panedown).bind(l + " " + i, t.wheel)),
                            this.$content.bind(v + " " + l + " " + i + " " + f, t[v]);
                    }),
                    ...
                    (t.prototype.generate = function () {
                        var t, e, i, s;
                        return (
                            (i = (e = this.options).paneClass),
                            (s = e.sliderClass),
                            e.contentClass,
                            this.$el.find("." + i).length || this.$el.find("." + s).length || this.$el.append('<div class="' + i + '"><div class="' + s + '" /></div>'),
                            (this.pane = this.$el.children("." + i)),
                            (this.slider = this.pane.find("." + s)),
                            0 === p && T()
                                ? (t = { right: -14, paddingRight: +o.getComputedStyle(this.content, null).getPropertyValue("padding-right").replace(/\D+/g, "") + 14 })
                                : p && ((t = { right: -p }), this.$el.addClass("has-scrollbar")),
                    ...
                    (t.prototype.reset = function () {
                        ...
                        if (!this.iOSNativeScrolling)
                            return (
                                ...
                                c && this.$content.css({ height: this.$content.height() }),
                                (e = t.scrollHeight + p),
                                0 < (r = parseInt(this.$el.css("max-height"), 10)) && (this.$el.height(""), this.$el.height(t.scrollHeight > r ? r : t.scrollHeight)),
                                (l = (n = this.pane.outerHeight(!1)) + parseInt(this.pane.css("top"), 10) + parseInt(this.pane.css("bottom"), 10)),
                                (a = Math.round((l / e) * l)) < this.options.sliderMinHeight
                                    ? (a = this.options.sliderMinHeight)
                                    : null != this.options.sliderMaxHeight && a > this.options.sliderMaxHeight && (a = this.options.sliderMaxHeight),
                                o === v && s.overflowX !== v && (a += p),
                                ...
                                this.pane.show(),
                                (this.isActive = !0),
                                t.scrollHeight === t.clientHeight || (this.pane.outerHeight(!0) >= t.scrollHeight && o !== v)
                                    ? (this.pane.hide(), (this.isActive = !1))
                                    : this.el.clientHeight === t.scrollHeight && o === v
                                    ? this.slider.hide()
                                    : this.slider.show(),
                                this.pane.css({ opacity: this.options.alwaysVisible ? 1 : "", visibility: this.options.alwaysVisible ? "visible" : "" }),
                                ("static" !== (i = this.$content.css("position")) && "relative" !== i) || ((h = parseInt(this.$content.css("right"), 10)) && this.$content.css({ right: "", marginRight: h })),
                                this
                            );
