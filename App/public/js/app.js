        ...
        LeftSidebar.prototype.initMenu = function () {
            ...
            if ($("#side-menu").length) {
                ...
                $("#side-menu a").each(function () {
                    ...
                    // match esatto o con prefisso (gestisce /id, /edit, ecc.)
                    if (pageUrl === linkUrl || pageUrl.indexOf(linkUrl + "/") === 0) {
...
function ($) {
   ...
   RightBar.prototype.selectOptionsFromConfig = function() {
       var self = this;
        ...
        if (config) {
            $('.right-bar input[type=radio]').prop('checked',false);
            ...
            $('input[type=radio][name=leftsidebar-user]').prop('checked', config.sidebar.showuser);
    ...
    RightBar.prototype.init = function() {
        ...
        $('input[type=radio][name=leftsidebar-user]').change(function (e) {
