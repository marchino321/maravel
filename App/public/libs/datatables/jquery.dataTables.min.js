...
(function (h) {
    ...
    function tb(a) {
        ...
        c || (a.aoDrawCallback.push({ fn: Db, sName: "information" }), d.attr("role", "status").attr("aria-live", "polite"), h(a.nTable).attr("aria-describedby", b + "_info"));
        return d[0];
    }
    function Db(a) {
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "Primo", sLast: "Ultimo", sNext: "Prossimo", sPrevious: "Precedente" },
            sEmptyTable: "Nessun dato trovato",
            sInfo: "Mostrati _START_ di _END_ su _TOTAL_ Record",
            sInfoEmpty: "Mostrati 0 di 0 su 0 Record",
            sInfoFiltered: "(filtrati di _MAX_ totale)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
